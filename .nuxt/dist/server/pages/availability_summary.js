...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("1b50882e", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_availability_summary_vue_vue_type_style_index_0_id_4a26f99e_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_availability_summary_vue_vue_type_style_index_0_id_4a26f99e_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_availability_summary_vue_vue_type_style_index_0_id_4a26f99e_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_availability_summary_vue_vue_type_style_index_0_id_4a26f99e_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_availability_summary_vue_vue_type_style_index_0_id_4a26f99e_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-4a26f99e]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-4a26f99e]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-header[data-v-4a26f99e]{align-items:center;display:flex;justify-content:space-between;margin-bottom:20px}.avail-title[data-v-4a26f99e]{color:var(--text-primary);font-weight:600;margin:0}.avail-filters[data-v-4a26f99e]{display:flex;gap:12px}.filter-input[data-v-4a26f99e]{align-items:center;background:var(--bg-card);border:1px solid var(--border-color);border-radius:8px;cursor:pointer;display:flex;gap:8px;min-width:130px;padding:6px 14px}.filter-label[data-v-4a26f99e]{color:var(--text-secondary);flex:1;font-size:13px}.filter-icon[data-v-4a26f99e]{color:var(--text-muted);font-size:18px}.state-panel[data-v-4a26f99e]{align-items:center;display:flex;flex-direction:column;gap:12px;justify-content:center;padding:60px 20px}.state-message[data-v-4a26f99e]{color:var(--text-secondary);text-align:center}.retry-btn[data-v-4a26f99e]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary)}.pending-card[data-v-4a26f99e]{text-align:center}.pending-note[data-v-4a26f99e]{color:var(--text-muted);font-size:12px;margin:8px 0 0}.avail-card[data-v-4a26f99e]{background:var(--bg-card);border-radius:14px;box-shadow:0 2px 8px var(--shadow-color);margin-bottom:16px;padding:20px}.avail-card-title[data-v-4a26f99e]{color:var(--text-secondary);font-size:14px;font-weight:600;margin:0 0 12px}@media only screen and (max-width:992px){.main-content[data-v-4a26f99e]{padding-left:20px}.avail-header[data-v-4a26f99e]{align-items:flex-start;flex-direction:column;gap:12px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/availability_summary.vue?vue&type=template&id=4a26f99e&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-4a26f99e>", "</main>", [_vm._ssrNode("<div class=\"avail-header\" data-v-4a26f99e><h5 class=\"avail-title\" data-v-4a26f99e>Availability Summary</h5> <div class=\"avail-filters\" data-v-4a26f99e><div class=\"filter-input\" data-v-4a26f99e><span class=\"filter-label\" data-v-4a26f99e>Date</span> <i class=\"material-icons filter-icon\" data-v-4a26f99e>calendar_today</i></div></div></div> "), _vm.loading ? _vm._ssrNode("<div class=\"state-panel\" data-v-4a26f99e>", "</div>", [_c('PreLoader')], 1) : _vm.error ? _vm._ssrNode("<div class=\"state-panel\" data-v-4a26f99e><p class=\"state-message\" data-v-4a26f99e>" + _vm._ssrEscape("Could not load availability summary: " + _vm._s(_vm.error)) + "</p> <button class=\"btn-flat retry-btn\" data-v-4a26f99e>Retry</button></div>") : [_vm._ssrNode("<div class=\"row\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<div class=\"card-panel avail-card\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<p class=\"avail-card-title center-align\" data-v-4a26f99e>" + _vm._ssrEscape("Feeders Meeting 20h+ (" + _vm._s(_vm.feeder_date) + ")") + "</p> "), _vm.feedersAvailData ? _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
  ...
  }) : _vm._e()], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<div class=\"card-panel avail-card\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<p class=\"avail-card-title center-align\" data-v-4a26f99e>" + _vm._ssrEscape("DTs Meeting 20h+ (" + _vm._s(_vm.dt_date) + ")") + "</p> "), _vm.dtsAvailData ? _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
  ...
  }) : _vm._e()], 2)]), _vm._ssrNode(" <div class=\"col s12 m4\" data-v-4a26f99e><div class=\"card-panel avail-card\" data-v-4a26f99e><p class=\"avail-card-title center-align\" data-v-4a26f99e>DT Availability Bands</p> <div style=\"position: relative; height: 200px;\" data-v-4a26f99e><canvas id=\"dtAvailChart\" data-v-4a26f99e></canvas></div></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<div class=\"card-panel avail-card pending-card\" data-v-4a26f99e>", "</div>", [_vm._ssrNode("<p class=\"avail-card-title center-align\" data-v-4a26f99e>Feeders &amp; DTs By Business Unit</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  }), _vm._ssrNode(" <p class=\"pending-note\" data-v-4a26f99e>Business unit / geographic breakdown not provided by the current endpoints</p>")], 2)])])]], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/availability_summary.vue?vue&type=template&id=4a26f99e&scoped=true
