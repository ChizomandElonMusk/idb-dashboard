exports.ids = [26,1,3,10,13,15,17];
exports.modules = {
...
module.exports.__inject__ = function (context) {
  add("6ada244e", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_07db49e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(123);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_07db49e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_07db49e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_07db49e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_07db49e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-07db49e4]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-07db49e4]{min-height:100vh;padding-left:280px;padding-right:20px;padding-top:20px;position:relative}.avail-header[data-v-07db49e4]{align-items:center;display:flex;justify-content:space-between;margin-bottom:20px}.avail-title[data-v-07db49e4]{color:var(--text-primary);font-weight:600;margin:0}.filter-pill[data-v-07db49e4]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;justify-content:space-between;min-width:140px;padding:8px 12px}.filter-label[data-v-07db49e4]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-07db49e4]{color:var(--text-muted);font-size:20px!important}.filter-pill-select[data-v-07db49e4]{cursor:default}.filter-pill-input[data-v-07db49e4]{appearance:none;-webkit-appearance:none;-moz-appearance:none;background:transparent;border:none;color:var(--text-secondary);cursor:pointer;flex:1;font-family:inherit;font-size:13px;height:auto;margin:0;min-width:0;outline:none;padding:0}.filter-pill-input option[data-v-07db49e4]{background:#fff;color:#222}.myto-error[data-v-07db49e4]{align-items:center;background:#fdecec;border-radius:10px;color:#c0392b;display:flex;font-size:13px;gap:12px;margin-bottom:16px;padding:10px 16px}.myto-retry[data-v-07db49e4]{background:#c0392b;border:none;border-radius:6px;color:#fff;cursor:pointer;font-size:12px;padding:4px 12px}.top-stat-card[data-v-07db49e4]{background:var(--bg-card);border-radius:14px;margin-bottom:12px;padding:18px 16px 14px}.top-stat-header[data-v-07db49e4]{align-items:flex-start;display:flex;gap:12px;margin-bottom:10px}.top-stat-icon-wrap[data-v-07db49e4]{align-items:center;border-radius:50%;display:flex;flex-shrink:0;height:46px;justify-content:center;width:46px}.amber-icon-wrap[data-v-07db49e4]{background-color:#fdf1de}.top-stat-icon[data-v-07db49e4]{font-size:22px!important}.amber-icon[data-v-07db49e4]{color:#f5a623}.top-stat-info[data-v-07db49e4]{flex:1}.top-stat-value[data-v-07db49e4]{color:var(--text-primary);font-size:26px;font-weight:700;line-height:1.1;margin:0 0 2px}.top-stat-label[data-v-07db49e4]{color:var(--text-muted);font-size:12px;margin:0}.top-stat-footer[data-v-07db49e4]{align-items:center;display:flex;justify-content:space-between}.footer-month[data-v-07db49e4]{color:var(--text-muted);font-size:12px}.footer-pill[data-v-07db49e4]{align-items:center;border-radius:999px;display:inline-flex;font-size:11px;font-weight:700;gap:2px;padding:2px 8px}.footer-pill-up[data-v-07db49e4]{background:rgba(27,138,90,.12);color:#1b8a5a}.footer-pill-down[data-v-07db49e4]{background:rgba(192,57,43,.12);color:#c0392b}.footer-pill .material-icons[data-v-07db49e4]{font-size:13px!important}.band-card[data-v-07db49e4]{background:var(--bg-card);border-radius:12px;margin-bottom:12px;padding:16px;text-align:center}.band-name[data-v-07db49e4]{color:var(--text-secondary);font-size:13px;margin:0 0 8px}.band-pct[data-v-07db49e4]{color:var(--text-primary);font-size:22px;font-weight:700;margin:0 0 4px}.band-status[data-v-07db49e4]{font-size:14px;font-weight:600;margin:0 0 6px}.band-target[data-v-07db49e4]{color:var(--text-muted);font-size:11px;margin:0}.trend-card[data-v-07db49e4]{background:var(--bg-card);border-radius:14px;margin-bottom:12px;padding:20px}.trend-header[data-v-07db49e4]{align-items:center;display:flex;justify-content:space-between;margin-bottom:16px}.trend-title[data-v-07db49e4]{color:var(--text-primary);font-size:15px;font-weight:600}.chart-tabs[data-v-07db49e4]{align-items:center;display:flex;gap:14px}.chart-tab[data-v-07db49e4]{color:var(--text-muted);cursor:pointer;font-size:13px;padding:4px 6px}.chart-tab.active[data-v-07db49e4]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary);font-weight:600;padding:4px 10px}.chart-icon-btn[data-v-07db49e4]{align-items:center;background:rgba(0,0,0,.05);background:var(--bg-card-alt,rgba(0,0,0,.05));border-radius:6px;color:var(--text-muted);display:flex;height:26px;justify-content:center;width:26px}.chart-callout-wrap[data-v-07db49e4]{position:relative}.chart-callout[data-v-07db49e4]{background:var(--bg-card);border:1px solid var(--border-color);border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,.08);box-shadow:0 2px 8px var(--shadow-color,rgba(0,0,0,.08));display:flex;flex-direction:column;line-height:1.3;padding:6px 12px;pointer-events:none;position:absolute}.callout-title[data-v-07db49e4]{color:var(--text-muted);font-size:11px}.callout-value[data-v-07db49e4]{color:var(--text-primary);font-size:13px;font-weight:700}.mini-chart-card[data-v-07db49e4]{background:var(--bg-card);border-radius:14px;margin-bottom:12px;padding:20px}.pie-card-title[data-v-07db49e4]{color:var(--text-secondary);font-size:13px;font-weight:600;margin:0 0 10px}@media only screen and (max-width:992px){.main-content[data-v-07db49e4]{padding-left:20px}.avail-header[data-v-07db49e4]{align-items:flex-start;flex-direction:column;gap:12px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/myto_dashboard.vue?vue&type=template&id=07db49e4&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-07db49e4>", "</main>", [_c('LoadingOverlay', {
    attrs: {
      "visible": _vm.loading
    }
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"avail-header\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<h5 class=\"avail-title\" data-v-07db49e4>Feeders MYTO Energy Dashboard</h5> "), _vm._ssrNode("<div class=\"filter-pill filter-pill-select\" data-v-07db49e4>", "</div>", [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.selectedFeederBand,
      expression: "selectedFeederBand"
    }],
    ...
    on: {
      "change": [function ($event) {
        ...
        _vm.selectedFeederBand = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }, _vm.loadSummary]
    }
  }, _vm._l(_vm.feederBands, function (fb) {
    return _c('option', {
      key: fb,
      domProps: {
        "value": fb
      }
    }, [_vm._v(_vm._s(fb === 'All' ? 'Feeder Band' : `Band ${fb}`))]);
  }), 0), _vm._ssrNode(" <i class=\"material-icons filter-arrow\" data-v-07db49e4>arrow_drop_down</i>")], 2)], 2), _vm._ssrNode(" " + (_vm.error ? "<div class=\"myto-error\" data-v-07db49e4>" + _vm._ssrEscape("\n            Couldn't load live data: " + _vm._s(_vm.error) + "\n            ") + "<button class=\"myto-retry\" data-v-07db49e4>Retry</button></div>" : "<!---->") + " "), _vm._ssrNode("<div class=\"row\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"col s12 m5\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"top-stat-header\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"top-stat-icon-wrap amber-icon-wrap\" data-v-07db49e4><i class=\"material-icons top-stat-icon amber-icon\" data-v-07db49e4>bolt</i></div> "), _vm._ssrNode("<div class=\"top-stat-info\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<p class=\"top-stat-value\" data-v-07db49e4>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.total_consumption
    }
  })], 1), _vm._ssrNode(" <p class=\"top-stat-label\" data-v-07db49e4>Total Consumption (MWh)</p>")], 2)], 2), _vm._ssrNode(" <div class=\"top-stat-footer\" data-v-07db49e4><span class=\"footer-month\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(_vm.consumption_month)) + "</span> <span" + _vm._ssrClass("footer-pill", _vm.consumptionUp ? 'footer-pill-up' : 'footer-pill-down') + " data-v-07db49e4>" + _vm._ssrEscape("\n                            " + _vm._s(_vm.consumption_change) + "\n                            ") + "<i class=\"material-icons tiny\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(_vm.consumptionUp ? 'arrow_upward' : 'arrow_downward')) + "</i></span></div>")], 2), _vm._ssrNode(" <div class=\"row\" style=\"margin-bottom: 0;\" data-v-07db49e4>" + _vm._ssrList(_vm.bandsRow1, function (band) {
    return "<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-07db49e4><div class=\"card-panel band-card\" data-v-07db49e4><p class=\"band-name\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.name)) + "</p> <p class=\"band-pct\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.pct)) + "</p> <p class=\"band-status\"" + _vm._ssrStyle(null, {
      color: band.color
    }, null) + " data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.status)) + "</p> <p class=\"band-target\" data-v-07db49e4>" + _vm._ssrEscape("NERC Target " + _vm._s(band.target)) + "</p></div></div>";
  }) + "</div> <div class=\"row\" style=\"margin-bottom: 0;\" data-v-07db49e4>" + _vm._ssrList(_vm.bandsRow2, function (band) {
    return "<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-07db49e4><div class=\"card-panel band-card\" data-v-07db49e4><p class=\"band-name\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.name)) + "</p> <p class=\"band-pct\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.pct)) + "</p> <p class=\"band-status\"" + _vm._ssrStyle(null, {
      color: band.color
    }, null) + " data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.status)) + "</p> <p class=\"band-target\" data-v-07db49e4>" + _vm._ssrEscape("NERC Target " + _vm._s(band.target)) + "</p></div></div>";
  }) + "</div> <div class=\"row\" data-v-07db49e4>" + _vm._ssrList(_vm.bandsRow3, function (band) {
    return "<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-07db49e4><div class=\"card-panel band-card\" data-v-07db49e4><p class=\"band-name\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.name)) + "</p> <p class=\"band-pct\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.pct)) + "</p> <p class=\"band-status\"" + _vm._ssrStyle(null, {
      color: band.color
    }, null) + " data-v-07db49e4>" + _vm._ssrEscape(_vm._s(band.status)) + "</p> <p class=\"band-target\" data-v-07db49e4>" + _vm._ssrEscape("NERC Target " + _vm._s(band.target)) + "</p></div></div>";
  }) + "</div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m7\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel trend-card\" data-v-07db49e4><div class=\"trend-header\" data-v-07db49e4><span class=\"trend-title\" data-v-07db49e4>Energy Consumption Trend</span> <div class=\"chart-tabs\" data-v-07db49e4><span" + _vm._ssrClass("chart-tab", {
    active: _vm.trendTab === 'Day'
  }) + " data-v-07db49e4>Day</span> <span" + _vm._ssrClass("chart-tab", {
    active: _vm.trendTab === 'Week'
  }) + " data-v-07db49e4>Week</span> <span" + _vm._ssrClass("chart-tab", {
    active: _vm.trendTab === 'Month'
  }) + " data-v-07db49e4>Month</span> <span class=\"chart-icon-btn\" data-v-07db49e4><i class=\"material-icons tiny\" data-v-07db49e4>calendar_today</i></span></div></div> <div class=\"chart-callout-wrap\" data-v-07db49e4><div style=\"position: relative; height: 220px;\" data-v-07db49e4><canvas id=\"consumptionTrendChart\" data-v-07db49e4></canvas></div> " + (_vm.trendCallout ? "<div class=\"chart-callout\"" + _vm._ssrStyle(null, {
    left: _vm.trendCallout.leftPct + '%',
    top: '6px'
  }, null) + " data-v-07db49e4><span class=\"callout-title\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(_vm.trendCallout.title)) + "</span> <span class=\"callout-value\" data-v-07db49e4>" + _vm._ssrEscape(_vm._s(_vm.trendCallout.value)) + "</span></div>" : "<!---->") + "</div></div> "), _vm._ssrNode("<div class=\"row\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"col s12 m6\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<p class=\"pie-card-title center\" data-v-07db49e4>Energy Per Feeder (MWh)</p> "), _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
      "chart-data": _vm.energyPerFeederData,
      "chart-options": _vm.doughnutOptions,
      "show-value-legend": true,
      "legend-cols": 2
    }
  })], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m6\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-07db49e4>", "</div>", [_vm._ssrNode("<p class=\"pie-card-title center\" data-v-07db49e4>Feeder Communication Status</p> "), _c('MeterCommunication', {
    attrs: {
      "percentage": _vm.feederCommunicationPct
    }
  })], 2)])], 2)], 2)], 2)], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/myto_dashboard.vue?vue&type=template&id=07db49e4&scoped=true
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/myto_dashboard.vue?vue&type=script&lang=js
...
/* harmony default export */ var myto_dashboardvue_type_script_lang_js = ({
  components: {
  ...
  data() {
    return {
      ...
      feederBands: controlCenterApi["b" /* FEEDER_BANDS */],
      trendTab: 'Day',
      total_consumption: '—',
      consumption_month: '',
      consumption_change: '—',
  ...
  computed: {
    bandsRow1() {
      return this.bands.slice(0, 2);
    },
    bandsRow2() {
      return this.bands.slice(2, 4);
    },
    bandsRow3() {
      return this.bands.slice(4, 5);
    }
  },
  async mounted() {
  ...
  methods: {
    ...
    async loadSummary() {
      ...
      this.error = null;
      try {
        const data = await Object(controlCenterApi["r" /* getMytoSummary */])({
    ...
    applySummary(data) {
      this.total_consumption = Object(controlCenterApi["g" /* formatNumber */])(data.total_consumption_mwh);
      this.consumption_month = data.period || '';
      const pct = data.period_vs_prev_pct;
      this.consumptionUp = (pct !== null && pct !== void 0 ? pct : 0) >= 0;
      ...
      this.energyPerFeederData = {
        ...
        datasets: [{
          data: perFeeder.map(b => b.mwh),
          backgroundColor: perFeeder.map(b => Object(controlCenterApi["d" /* bandColor */])(b.band)),
          borderWidth: 0
        }]
      };
    ...
    updateTrendView() {
      const points = Object(controlCenterApi["c" /* aggregateDailyTrend */])(this.energyRawTrend, this.trendTab, ['mwh']);
      this.trendLabels = points.map(p => p.label);
      this.trendValues = points.map(p => p.mwh);
      this.trendCallout = Object(controlCenterApi["e" /* buildTrendCallout */])(points, 'mwh', p => p.label, v => `${Object(controlCenterApi["g" /* formatNumber */])(v)} MWh`);
    },
    renderTrendChart() {
...
// CONCATENATED MODULE: ./pages/myto_dashboard.vue?vue&type=script&lang=js
 /* harmony default export */ var pages_myto_dashboardvue_type_script_lang_js = (myto_dashboardvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/myto_dashboard.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_myto_dashboardvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var myto_dashboard = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=myto_dashboard.js.map