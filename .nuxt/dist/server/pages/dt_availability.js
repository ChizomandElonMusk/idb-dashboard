...
module.exports.__inject__ = function (context) {
  add("34be2fca", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_6301bc50_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(118);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_6301bc50_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_6301bc50_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_6301bc50_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_6301bc50_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-6301bc50]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-6301bc50]{padding-left:280px;padding-right:20px;padding-top:20px}.tab-panel[data-v-6301bc50]{min-height:60vh;position:relative}.avail-title[data-v-6301bc50]{color:var(--text-primary);font-weight:600;margin:0}.tabs[data-v-6301bc50]{background:transparent;border-bottom:1px solid var(--border-strong);margin-bottom:20px}.tabs .tab a[data-v-6301bc50]{align-items:center;color:var(--text-muted);display:flex;font-size:14px;gap:6px;text-transform:none}.tabs .tab a .tab-icon[data-v-6301bc50]{font-size:16px!important}.tabs .tab a.active.dashboard-tab[data-v-6301bc50]{border-bottom:2px solid #c0392b;color:#c0392b}.tabs .tab a.active.table-tab[data-v-6301bc50]{border-bottom:2px solid #e8941a;color:#e8941a}.tabs .indicator[data-v-6301bc50]{display:none}.filter-row[data-v-6301bc50]{margin-bottom:10px}.filter-pill[data-v-6301bc50]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;justify-content:space-between;padding:8px 12px}.filter-label[data-v-6301bc50]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-6301bc50]{color:var(--text-muted);font-size:20px!important}.filter-pill-date[data-v-6301bc50]{cursor:default}.filter-pill-input[data-v-6301bc50]{background:transparent;border:none;color:var(--text-secondary);flex:1;font-family:inherit;font-size:13px;height:auto;margin:0;min-width:0;outline:none;padding:0}.filter-pill-date .filter-pill-input[data-v-6301bc50]{cursor:pointer}.filter-pill-date .filter-pill-input[data-v-6301bc50]::-webkit-calendar-picker-indicator{opacity:0}.filter-pill-select[data-v-6301bc50]{cursor:default}select.filter-pill-input[data-v-6301bc50]{appearance:none;-webkit-appearance:none;-moz-appearance:none;cursor:pointer}select.filter-pill-input option[data-v-6301bc50]{background:#fff;color:#222}.dt-status-banner[data-v-6301bc50]{border-radius:10px;font-size:13px;margin-bottom:16px;padding:10px 16px}.dt-error[data-v-6301bc50]{background:#fdecec;color:#c0392b}.dt-empty[data-v-6301bc50]{background:var(--bg-card-alt);color:var(--text-secondary)}.dt-table-empty[data-v-6301bc50]{background:var(--bg-card);color:var(--text-muted);padding:20px 16px;text-align:center}.table-pagination[data-v-6301bc50]{align-items:center;display:flex;justify-content:space-between;margin-top:14px}.table-pagination-info[data-v-6301bc50]{color:var(--text-muted);font-size:12px}.table-pagination-btns[data-v-6301bc50]{display:flex;gap:8px}.pagination-btn[data-v-6301bc50]{background:var(--bg-card);border:1px solid var(--border-strong);border-radius:6px;color:var(--text-secondary);cursor:pointer;font-size:13px;padding:6px 14px}.pagination-btn[data-v-6301bc50]:disabled{cursor:not-allowed;opacity:.5}.metric-card[data-v-6301bc50]{border-radius:12px;display:flex;flex-direction:column;justify-content:space-between;margin-bottom:12px;min-height:90px;padding:16px}.metric-label[data-v-6301bc50]{color:var(--text-muted);font-size:11px;line-height:1.4;margin:0 0 8px}.metric-value[data-v-6301bc50]{color:var(--text-primary);font-size:22px;font-weight:700;margin:0}.green-value[data-v-6301bc50]{color:#27ae60}.trend-card[data-v-6301bc50]{border-radius:12px;padding:20px}.trend-header[data-v-6301bc50]{align-items:center;display:flex;justify-content:space-between;margin-bottom:16px}.trend-title[data-v-6301bc50]{color:var(--text-primary);font-size:15px;font-weight:600}.chart-tabs[data-v-6301bc50]{align-items:center;display:flex;gap:14px}.chart-tab[data-v-6301bc50]{color:var(--text-muted);cursor:pointer;font-size:13px;padding:4px 6px}.chart-tab.active[data-v-6301bc50]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary);font-weight:600;padding:4px 10px}.chart-icon-btn[data-v-6301bc50]{align-items:center;background:rgba(0,0,0,.05);background:var(--bg-card-alt,rgba(0,0,0,.05));border-radius:6px;color:var(--text-muted);display:flex;height:26px;justify-content:center;width:26px}.chart-callout-wrap[data-v-6301bc50]{position:relative}.chart-callout[data-v-6301bc50]{background:var(--bg-card);border:1px solid var(--border-color);border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,.08);box-shadow:0 2px 8px var(--shadow-color,rgba(0,0,0,.08));display:flex;flex-direction:column;line-height:1.3;padding:6px 12px;pointer-events:none;position:absolute}.callout-title[data-v-6301bc50]{color:var(--text-muted);font-size:11px}.callout-value[data-v-6301bc50]{color:var(--text-primary);font-size:13px;font-weight:700}.trend-legend[data-v-6301bc50]{border-top:1px solid var(--divider);display:flex;gap:24px;margin-top:12px;padding-top:12px}.legend-item[data-v-6301bc50]{align-items:center;color:var(--text-secondary);display:flex;font-size:13px;gap:8px}.legend-ring[data-v-6301bc50]{border:3px solid transparent;border-radius:50%;display:inline-block;height:14px;width:14px}.green-ring[data-v-6301bc50]{background:rgba(78,203,113,.15);border-color:#4ecb71}.blue-ring[data-v-6301bc50]{background:rgba(91,124,250,.15);border-color:#5b7cfa}.table-wrapper[data-v-6301bc50]{overflow-x:auto;-webkit-overflow-scrolling:touch}.dt-table[data-v-6301bc50]{border-collapse:separate;border-spacing:0 6px;width:100%}.dt-table thead tr th[data-v-6301bc50]{background-color:#e8941a;color:#fff;font-size:13px;font-weight:500;padding:14px 16px;white-space:nowrap}.dt-table thead tr th[data-v-6301bc50]:first-child{border-radius:10px 0 0 10px}.dt-table thead tr th[data-v-6301bc50]:last-child{border-radius:0 10px 10px 0}.dt-table tbody tr td[data-v-6301bc50]{background:var(--bg-card);border-bottom:1px solid var(--border-color);border-top:1px solid var(--border-color);color:var(--text-secondary);font-size:13px;padding:12px 16px}.dt-table tbody tr td[data-v-6301bc50]:first-child{border-left:1px solid var(--border-color);border-radius:8px 0 0 8px}.dt-table tbody tr td[data-v-6301bc50]:last-child{border-radius:0 8px 8px 0;border-right:1px solid var(--border-color)}@media only screen and (max-width:992px){.main-content[data-v-6301bc50]{padding-left:20px}}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dt_availability.vue?vue&type=template&id=6301bc50&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-6301bc50>", "</main>", [_vm._ssrNode("<div class=\"row header-row\" style=\"margin-bottom: 0;\" data-v-6301bc50><div class=\"col s12\" data-v-6301bc50><h5 class=\"avail-title\" data-v-6301bc50>DT Availability Dashboard</h5> <ul class=\"tabs\" data-v-6301bc50><li class=\"tab\" data-v-6301bc50><a href=\"#dt-dashboard\" class=\"active tab-link dashboard-tab\" data-v-6301bc50><i class=\"material-icons tiny tab-icon\" data-v-6301bc50>speed</i> Dashboard\n                        </a></li> <li class=\"tab\" data-v-6301bc50><a href=\"#dt-table\" class=\"tab-link table-tab\" data-v-6301bc50><i class=\"material-icons tiny tab-icon\" data-v-6301bc50>apps</i> DT Availability Table\n                        </a></li></ul></div></div> "), _vm._ssrNode("<div id=\"dt-dashboard\" class=\"tab-panel\" data-v-6301bc50>", "</div>", [_c('LoadingOverlay', {
    attrs: {
      "visible": _vm.dashboardLoading
    }
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row filter-row\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"col s4 offset-s8\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"filter-pill filter-pill-select\" data-v-6301bc50>", "</div>", [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.dtSearchInput,
      expression: "dtSearchInput"
    }],
    ...
    on: {
      "change": [function ($event) {
        ...
        _vm.dtSearchInput = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }, _vm.searchDt]
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("All")]), _vm._v(" "), _vm._l(_vm.knownDtNames, function (name) {
    return _c('option', {
      key: name,
      domProps: {
        "value": name
  ...
  })], 2), _vm._ssrNode(" <i class=\"material-icons filter-arrow\" data-v-6301bc50>arrow_drop_down</i>")], 2)])]), _vm._ssrNode(" " + (_vm.dashboardError ? "<div class=\"dt-status-banner dt-error\" data-v-6301bc50>" + _vm._ssrEscape("\n                Couldn't load DT dashboard: " + _vm._s(_vm.dashboardError) + "\n            ") + "</div>" : !_vm.dashboardLoading && !_vm.dtNameQuery ? "<div class=\"dt-status-banner dt-empty\" data-v-6301bc50>\n                Select a DT above to see its availability dashboard.\n            </div>" : "<!---->") + " "), _vm.dtNameQuery ? _vm._ssrNode("<div class=\"row\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-6301bc50><div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-6301bc50><div class=\"card-panel metric-card\" data-v-6301bc50><p class=\"metric-label\" data-v-6301bc50>DT Target Availability (Hrs)</p> <p class=\"metric-value\" data-v-6301bc50>" + _vm._ssrEscape(_vm._s(_vm.dt_target_availability)) + "</p></div></div> <div class=\"col s6\" style=\"padding: 0 0 0 6px;\" data-v-6301bc50><div class=\"card-panel metric-card\" data-v-6301bc50><p class=\"metric-label\" data-v-6301bc50>Feeder Target Availability(Hrs)</p> <p class=\"metric-value\" data-v-6301bc50>" + _vm._ssrEscape(_vm._s(_vm.feeder_target_availability)) + "</p></div></div></div> "), _vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-6301bc50>DT Actual Availability (Hrs)</p> "), _vm._ssrNode("<p class=\"metric-value green-value\" data-v-6301bc50>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.dt_actual_availability
    }
  })], 1)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 0 0 6px;\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-6301bc50>Feeder Actual Availability (Hrs)</p> "), _vm._ssrNode("<p class=\"metric-value green-value\" data-v-6301bc50>", "</p>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.feeder_actual_availability
    }
  })], 1)], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-6301bc50>Availability Rate(%)</p> "), _vm._ssrNode("<p class=\"metric-value green-value\" data-v-6301bc50>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.dt_availability_rate
    }
  })], 1)], 2)]), _vm._ssrNode(" <div class=\"col s6\" style=\"padding: 0 0 0 6px;\" data-v-6301bc50><div class=\"card-panel metric-card\" data-v-6301bc50><p class=\"metric-label\" data-v-6301bc50>Feeder Availability Status</p> <p class=\"metric-value green-value\" data-v-6301bc50>" + _vm._ssrEscape(_vm._s(_vm.feeder_availability_status)) + "</p></div></div>")], 2)], 2), _vm._ssrNode(" <div class=\"col s12 m8\" data-v-6301bc50><div class=\"card-panel trend-card\" data-v-6301bc50><div class=\"trend-header\" data-v-6301bc50><span class=\"trend-title\" data-v-6301bc50>Availability Trend</span> <div class=\"chart-tabs\" data-v-6301bc50><span" + _vm._ssrClass("chart-tab", {
    active: _vm.trendTab === 'Day'
  }) + " data-v-6301bc50>Day</span> <span" + _vm._ssrClass("chart-tab", {
    active: _vm.trendTab === 'Week'
  }) + " data-v-6301bc50>Week</span> <span" + _vm._ssrClass("chart-tab", {
    active: _vm.trendTab === 'Month'
  }) + " data-v-6301bc50>Month</span> <span class=\"chart-icon-btn\" data-v-6301bc50><i class=\"material-icons tiny\" data-v-6301bc50>calendar_today</i></span></div></div> <div class=\"chart-callout-wrap\" data-v-6301bc50><div style=\"position: relative; height: 250px;\" data-v-6301bc50><canvas id=\"availabilityChart\" data-v-6301bc50></canvas></div> " + (_vm.trendCallout ? "<div class=\"chart-callout\"" + _vm._ssrStyle(null, {
    left: _vm.trendCallout.leftPct + '%',
    top: '20px'
  }, null) + " data-v-6301bc50><span class=\"callout-title\" data-v-6301bc50>" + _vm._ssrEscape(_vm._s(_vm.trendCallout.title)) + "</span> <span class=\"callout-value\" data-v-6301bc50>" + _vm._ssrEscape(_vm._s(_vm.trendCallout.value)) + "</span></div>" : "<!---->") + "</div> <div class=\"trend-legend\" data-v-6301bc50><span class=\"legend-item\" data-v-6301bc50><span class=\"legend-ring green-ring\" data-v-6301bc50></span> <span class=\"legend-text\" data-v-6301bc50>Average Availability</span></span> <span class=\"legend-item\" data-v-6301bc50><span class=\"legend-ring blue-ring\" data-v-6301bc50></span> <span class=\"legend-text\" data-v-6301bc50>Average Target</span></span></div></div></div>")], 2) : _vm._e()], 2), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"dt-table\" class=\"tab-panel\" data-v-6301bc50>", "</div>", [_c('LoadingOverlay', {
    attrs: {
      "visible": _vm.tableLoading
    }
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row filter-row\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"col s3 offset-s6\" data-v-6301bc50>", "</div>", [_vm._ssrNode("<div class=\"filter-pill filter-pill-select\" data-v-6301bc50>", "</div>", [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.tableDtName,
      expression: "tableDtName"
    }],
    staticClass: "filter-pill-input",
    on: {
      "change": [function ($event) {
        ...
        _vm.tableDtName = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }, _vm.onTableDtNameChange]
    }
  }, [_c('option', {
    attrs: {
      "value": "All"
    }
  }, [_vm._v("All DTs")]), _vm._v(" "), _vm._l(_vm.knownDtNames, function (name) {
    return _c('option', {
      key: name,
      domProps: {
        "value": name
  ...
  })], 2), _vm._ssrNode(" <i class=\"material-icons filter-arrow\" data-v-6301bc50>arrow_drop_down</i>")], 2)]), _vm._ssrNode(" <div class=\"col s3\" data-v-6301bc50><div class=\"filter-pill filter-pill-date\" data-v-6301bc50><input type=\"date\"" + _vm._ssrAttr("max", _vm.maxDate) + _vm._ssrAttr("value", _vm.tableDate) + " class=\"filter-pill-input\" data-v-6301bc50> <i class=\"material-icons filter-arrow\" style=\"font-size:18px;\" data-v-6301bc50>calendar_today</i></div></div>")], 2), _vm._ssrNode(" " + (_vm.tableError ? "<div class=\"dt-status-banner dt-error\" data-v-6301bc50>" + _vm._ssrEscape("\n                Couldn't load DT table: " + _vm._s(_vm.tableError) + "\n            ") + "</div>" : "<!---->") + " <div class=\"table-wrapper\" data-v-6301bc50><table class=\"dt-table\" data-v-6301bc50><thead data-v-6301bc50><tr data-v-6301bc50><th data-v-6301bc50>Date</th> <th data-v-6301bc50>DT Name</th> <th data-v-6301bc50>Name_Of_Feeder</th> <th data-v-6301bc50>Band</th> <th data-v-6301bc50>Consumption</th> <th data-v-6301bc50>DT Actual Availability</th></tr></thead> <tbody data-v-6301bc50>" + _vm._ssrList(_vm.dt_availability_rows, function (row, i) {
    return "<tr data-v-6301bc50><td data-v-6301bc50>" + _vm._ssrEscape(_vm._s(row.date)) + "</td> <td data-v-6301bc50>" + _vm._ssrEscape(_vm._s(row.dt_name)) + "</td> <td data-v-6301bc50>" + _vm._ssrEscape(_vm._s(row.feeder_name)) + "</td> <td data-v-6301bc50>" + _vm._ssrEscape(_vm._s(row.band)) + "</td> <td data-v-6301bc50>" + _vm._ssrEscape(_vm._s(row.consumption)) + "</td> <td data-v-6301bc50>" + _vm._ssrEscape(_vm._s(row.availability)) + "</td></tr>";
  }) + " " + (!_vm.tableLoading && !_vm.dt_availability_rows.length ? "<tr data-v-6301bc50><td colspan=\"6\" class=\"dt-table-empty\" data-v-6301bc50>No rows for this filter combination.</td></tr>" : "<!---->") + "</tbody></table></div> <div class=\"table-pagination\" data-v-6301bc50><span class=\"table-pagination-info\" data-v-6301bc50>" + _vm._ssrEscape(_vm._s(_vm.tablePaginationLabel)) + "</span> <div class=\"table-pagination-btns\" data-v-6301bc50><button" + _vm._ssrAttr("disabled", _vm.tablePage <= 1) + " class=\"pagination-btn\" data-v-6301bc50>Prev</button> <button" + _vm._ssrAttr("disabled", _vm.tableTotalPages > 0 && _vm.tablePage >= _vm.tableTotalPages) + " class=\"pagination-btn\" data-v-6301bc50>Next</button></div></div>")], 2)], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/dt_availability.vue?vue&type=template&id=6301bc50&scoped=true
...
/* harmony default export */ var dt_availabilityvue_type_script_lang_js = ({
  ...
  data() {
    return {
      ...
      tableDate: '',
      maxDate: Object(controlCenterApi["v" /* todayStr */])(),
      tablePage: 1,
  ...
  computed: {
    tablePaginationLabel() {
      ...
      return `Page ${this.tablePage} of ${this.tableTotalPages} · ${Object(controlCenterApi["g" /* formatNumber */])(this.tableTotal)} rows`;
    }
  },
  async mounted() {
  ...
  methods: {
    ...
    async seedDtNameOptions() {
      try {
        const data = await Object(controlCenterApi["l" /* getDtAvailabilityTable */])({
          dt_name: 'All',
          date: this.tableDate,
          page: 1,
          page_size: 100
    ...
    mergeKnownDtNames(rows) {
      ...
      rows.forEach(r => {
        if (r.dt_name) seen.add(r.dt_name);
      });
    ...
    async loadDashboard() {
      ...
      try {
        const data = await Object(controlCenterApi["k" /* getDtAvailabilityDashboard */])({
          dt_name: this.dtNameQuery,
          period: this.trendTab
        });
    ...
    applyDashboard(data) {
      ...
      this.dt_target_availability = Object(controlCenterApi["g" /* formatNumber */])(dt.target_hours);
      this.feeder_target_availability = Object(controlCenterApi["g" /* formatNumber */])(feeder.target_hours);
      this.dt_actual_availability = Object(controlCenterApi["g" /* formatNumber */])(dt.actual_hours);
      this.feeder_actual_availability = Object(controlCenterApi["g" /* formatNumber */])(feeder.actual_hours);
      this.dt_availability_rate = Object(controlCenterApi["g" /* formatNumber */])(dt.availability_rate_pct);
      ...
      const labelOf = t => Object(controlCenterApi["u" /* pick */])(t, ['month', 'week', 'day', 'date', 'label'], '');
      ...
      this.trendCallout = Object(controlCenterApi["e" /* buildTrendCallout */])(trend, 'avg_availability', labelOf, v => Object(controlCenterApi["g" /* formatNumber */])(v));
    ...
    async loadTable() {
      ...
      try {
        ...
        this.dt_availability_rows = (data.data || []).map(row => ({
          ...
          band: row.band,
          consumption: Object(controlCenterApi["g" /* formatNumber */])(row.consumption_kwh),
          availability: Object(controlCenterApi["g" /* formatNumber */])(row.dt_actual_availability_hrs)
        }));
        this.mergeKnownDtNames(data.data || []);
      } catch (err) {
...
installComponents(component, {SideNav: __webpack_require__(78).default,LoadingOverlay: __webpack_require__(80).default,AnimatedValue: __webpack_require__(82).default})
...
//# sourceMappingURL=dt_availability.js.map