...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("0effb176", content, true, context)
};
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-4b5060be]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-4b5060be]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-title[data-v-4b5060be]{color:var(--text-primary);font-weight:600;margin:0}.tabs[data-v-4b5060be]{background:transparent;border-bottom:1px solid var(--border-strong);margin-bottom:20px}.tabs .tab a[data-v-4b5060be]{align-items:center;color:var(--text-muted);display:flex;font-size:14px;gap:6px;text-transform:none}.tabs .tab a .tab-icon[data-v-4b5060be]{font-size:16px!important}.tabs .tab a.active.dashboard-tab[data-v-4b5060be]{border-bottom:2px solid #c0392b;color:#c0392b}.tabs .tab a.active.table-tab[data-v-4b5060be]{border-bottom:2px solid #e8941a;color:#e8941a}.tabs .indicator[data-v-4b5060be]{display:none}.filter-row[data-v-4b5060be]{margin-bottom:10px}.filter-pill[data-v-4b5060be]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;justify-content:space-between;padding:8px 12px}.filter-label[data-v-4b5060be]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-4b5060be]{color:var(--text-muted);font-size:20px!important}.metric-card[data-v-4b5060be]{border-radius:12px;display:flex;flex-direction:column;justify-content:space-between;margin-bottom:12px;min-height:90px;padding:16px}.metric-label[data-v-4b5060be]{color:var(--text-muted);font-size:11px;line-height:1.4;margin:0 0 8px}.metric-value[data-v-4b5060be]{color:var(--text-primary);font-size:22px;font-weight:700;margin:0}.green-value[data-v-4b5060be]{color:#27ae60}.trend-card[data-v-4b5060be]{border-radius:12px;padding:20px}.trend-header[data-v-4b5060be]{align-items:center;display:flex;justify-content:space-between;margin-bottom:16px}.trend-title[data-v-4b5060be]{color:var(--text-primary);font-size:15px;font-weight:600}.chart-tabs[data-v-4b5060be]{align-items:center;display:flex;gap:14px}.chart-tab[data-v-4b5060be]{color:var(--text-muted);cursor:pointer;font-size:13px;padding:4px 6px}.chart-tab.active[data-v-4b5060be]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary);font-weight:600;padding:4px 10px}.chart-icon-btn[data-v-4b5060be]{align-items:center;background:rgba(0,0,0,.05);background:var(--bg-card-alt,rgba(0,0,0,.05));border-radius:6px;color:var(--text-muted);display:flex;height:26px;justify-content:center;width:26px}.chart-callout-wrap[data-v-4b5060be]{position:relative}.chart-callout[data-v-4b5060be]{background:var(--bg-card);border:1px solid var(--border-color);border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,.08);box-shadow:0 2px 8px var(--shadow-color,rgba(0,0,0,.08));display:flex;flex-direction:column;line-height:1.3;padding:6px 12px;pointer-events:none;position:absolute}.callout-title[data-v-4b5060be]{color:var(--text-muted);font-size:11px}.callout-value[data-v-4b5060be]{color:var(--text-primary);font-size:13px;font-weight:700}.trend-legend[data-v-4b5060be]{border-top:1px solid var(--divider);display:flex;gap:24px;margin-top:12px;padding-top:12px}.legend-item[data-v-4b5060be]{align-items:center;color:var(--text-secondary);display:flex;font-size:13px;gap:8px}.legend-ring[data-v-4b5060be]{border:3px solid transparent;border-radius:50%;display:inline-block;height:14px;width:14px}.green-ring[data-v-4b5060be]{background:rgba(78,203,113,.15);border-color:#4ecb71}.blue-ring[data-v-4b5060be]{background:rgba(91,124,250,.15);border-color:#5b7cfa}.table-wrapper[data-v-4b5060be]{overflow-x:auto;-webkit-overflow-scrolling:touch}.dt-table[data-v-4b5060be]{border-collapse:separate;border-spacing:0 6px;width:100%}.dt-table thead tr th[data-v-4b5060be]{background-color:#e8941a;color:#fff;font-size:13px;font-weight:500;padding:14px 16px;white-space:nowrap}.dt-table thead tr th[data-v-4b5060be]:first-child{border-radius:10px 0 0 10px}.dt-table thead tr th[data-v-4b5060be]:last-child{border-radius:0 10px 10px 0}.dt-table tbody tr td[data-v-4b5060be]{background:var(--bg-card);border-bottom:1px solid var(--border-color);border-top:1px solid var(--border-color);color:var(--text-secondary);font-size:13px;padding:12px 16px}.dt-table tbody tr td[data-v-4b5060be]:first-child{border-left:1px solid var(--border-color);border-radius:8px 0 0 8px}.dt-table tbody tr td[data-v-4b5060be]:last-child{border-radius:0 8px 8px 0;border-right:1px solid var(--border-color)}@media only screen and (max-width:992px){.main-content[data-v-4b5060be]{padding-left:20px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
