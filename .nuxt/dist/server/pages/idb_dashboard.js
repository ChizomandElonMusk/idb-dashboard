...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/ChartPie.vue?vue&type=template&id=34e817af&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "chart-pie-wrapper"
  }, [_vm._ssrNode("<div class=\"chart-canvas-container\" data-v-34e817af><canvas data-v-34e817af></canvas> " + (_vm.centerText ? "<div class=\"chart-center-text\" data-v-34e817af>" + _vm._ssrEscape(_vm._s(_vm.centerText)) + "</div>" : "<!---->") + "</div> " + (_vm.showValueLegend && _vm.chartData ? "<div class=\"chart-legend\" data-v-34e817af><div class=\"legend-grid\"" + _vm._ssrStyle(null, {
    gridTemplateColumns: `repeat(${_vm.legendCols}, 1fr)`
  }, null) + " data-v-34e817af>" + _vm._ssrList(_vm.chartData.labels, function (label, i) {
    return "<div class=\"legend-item\" data-v-34e817af><span class=\"legend-dot\"" + _vm._ssrStyle(null, {
      backgroundColor: _vm.chartData.datasets[0].backgroundColor[i]
    }, null) + " data-v-34e817af></span> <span class=\"legend-label\" data-v-34e817af>" + _vm._ssrEscape(_vm._s(label)) + "</span> <span class=\"legend-value\" data-v-34e817af>" + _vm._ssrEscape(_vm._s(_vm.chartData.datasets[0].data[i])) + "</span></div>";
  }) + "</div></div>" : "<!---->"))]);
};
var staticRenderFns = [];
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".chart-pie-wrapper[data-v-34e817af]{width:100%}.chart-canvas-container[data-v-34e817af]{height:200px;position:relative}.chart-center-text[data-v-34e817af]{color:var(--text-primary);font-size:1rem;font-weight:700;left:50%;pointer-events:none;position:absolute;top:50%;transform:translate(-50%,-50%)}.chart-legend[data-v-34e817af]{margin-top:16px}.legend-grid[data-v-34e817af]{display:grid;grid-gap:8px 16px;gap:8px 16px}.legend-item[data-v-34e817af]{align-items:center;display:flex;font-size:12px;gap:6px}.legend-dot[data-v-34e817af]{border-radius:50%;flex-shrink:0;height:12px;width:12px}.legend-label[data-v-34e817af]{color:var(--text-secondary);flex:1}.legend-value[data-v-34e817af]{color:var(--text-primary);font-weight:700}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("06f4561f", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_74d30af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_74d30af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_74d30af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_74d30af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_74d30af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-74d30af8]{background-color:var(--bg-page);min-height:100vh}.sidenav[data-v-74d30af8]{border-right:1px solid var(--border-color);width:260px}.main-content[data-v-74d30af8]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-title[data-v-74d30af8]{color:var(--text-primary);font-weight:600;margin:0}.stats-card[data-v-74d30af8]{border-radius:12px;position:relative}.icon-circle[data-v-74d30af8]{align-items:center;border-radius:50%;display:flex;height:50px;justify-content:center;margin-right:15px;width:50px}.stats-text .value[data-v-74d30af8]{display:inline-block;font-size:24px;font-weight:700}.counting[data-v-74d30af8]{animation:pop-74d30af8 1s ease-out}@keyframes pop-74d30af8{0%{transform:scale(1)}50%{transform:scale(1.4)}to{transform:scale(1)}}.stats-text p[data-v-74d30af8]{font-size:12px;margin:0}.badge[data-v-74d30af8]{border-radius:4px!important;position:absolute;right:15px;top:15px}.mini-chart-card[data-v-74d30af8]{border-radius:12px;margin-bottom:10px}.tiny-text[data-v-74d30af8]{font-size:11px;margin-bottom:5px}.border-right[data-v-74d30af8]{border-right:1px solid var(--border-color)}.circle[data-v-74d30af8]{border-radius:50%;display:inline-block;vertical-align:middle}.circle.orange[data-v-74d30af8]{background-color:orange}.circle.green[data-v-74d30af8]{background-color:green}.tabs[data-v-74d30af8]{background:transparent;border-bottom:1px solid var(--border-strong);margin-bottom:8px}.tabs .tab a[data-v-74d30af8]{align-items:center;color:var(--text-muted);display:flex;font-size:14px;gap:6px;text-transform:none}.tabs .tab a .tab-icon[data-v-74d30af8]{font-size:16px!important}.tabs .tab a.active.dashboard-tab[data-v-74d30af8]{border-bottom:2px solid #c0392b;color:#c0392b}.tabs .tab a.active.customer-tab[data-v-74d30af8],.tabs .tab a.active.feeder-tab[data-v-74d30af8]{border-bottom:2px solid #e8941a;color:#e8941a}.tabs .indicator[data-v-74d30af8]{display:none}.filter-row-right[data-v-74d30af8]{display:flex;gap:10px;justify-content:flex-end;margin-bottom:16px}.filter-pill[data-v-74d30af8]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;gap:6px;min-width:110px;padding:8px 12px}.filter-label[data-v-74d30af8]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-74d30af8]{color:var(--text-muted);font-size:20px!important}.chart-legend-list[data-v-74d30af8]{margin-top:10px}.cleg-item[data-v-74d30af8]{align-items:center;display:flex;gap:6px;margin-bottom:5px}.cleg-dot[data-v-74d30af8]{border-radius:50%;flex-shrink:0;height:10px;width:10px}.cleg-label[data-v-74d30af8]{color:var(--text-secondary);flex:1;font-size:12px}.cleg-val[data-v-74d30af8]{color:var(--text-primary);font-size:12px;font-weight:700}table.rounded-header thead.orange[data-v-74d30af8],table.rounded-header2 thead.red-accent-4[data-v-74d30af8]{border-radius:20px;display:table-header-group;overflow:hidden}table.rounded-header[data-v-74d30af8],table.rounded-header2[data-v-74d30af8]{border-collapse:separate;border-spacing:0}table.rounded-header thead.orange th[data-v-74d30af8]{background-color:orange;color:#fff;padding:10px 15px}table.rounded-header2 thead.red-accent-4 th[data-v-74d30af8]{background-color:#d50000;color:#fff;padding:10px 15px}table.rounded-header thead.orange th[data-v-74d30af8]:first-child,table.rounded-header2 thead.red-accent-4 th[data-v-74d30af8]:first-child{border-bottom-left-radius:10px;border-top-left-radius:10px}table.rounded-header thead.orange th[data-v-74d30af8]:last-child,table.rounded-header2 thead.red-accent-4 th[data-v-74d30af8]:last-child{border-bottom-right-radius:10px;border-top-right-radius:10px}table.rounded-header thead.orange th[data-v-74d30af8]:not(:first-child):not(:last-child),table.rounded-header2 thead.red-accent-4 th[data-v-74d30af8]:not(:first-child):not(:last-child){border-radius:0}.table-wrapper[data-v-74d30af8]{overflow-x:auto;-webkit-overflow-scrolling:touch}.table-wrapper table[data-v-74d30af8]{width:-moz-max-content;width:max-content}@media only screen and (max-width:992px){.main-content[data-v-74d30af8]{padding-left:20px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/idb_dashboard.vue?vue&type=template&id=74d30af8&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-74d30af8>", "</main>", [_vm._ssrNode("<div class=\"row header-row\" style=\"margin-bottom: 0;\" data-v-74d30af8><div class=\"col s12\" data-v-74d30af8><h5 class=\"avail-title\" data-v-74d30af8>IDB Dashboard</h5> <ul class=\"tabs\" data-v-74d30af8><li class=\"tab\" data-v-74d30af8><a href=\"#dashboard\" class=\"active tab-link dashboard-tab\" data-v-74d30af8><i class=\"material-icons tiny tab-icon\" data-v-74d30af8>speed</i> Dashboard\n                        </a></li> <li class=\"tab\" data-v-74d30af8><a href=\"#feeder-loss\" class=\"tab-link feeder-tab\" data-v-74d30af8><i class=\"material-icons tiny tab-icon\" data-v-74d30af8>apps</i> Feeder to DT loss Table\n                        </a></li> <li class=\"tab\" data-v-74d30af8><a href=\"#customer-loss\" class=\"tab-link customer-tab\" data-v-74d30af8><i class=\"material-icons tiny tab-icon\" data-v-74d30af8>apps</i> Customer to DT loss Table\n                        </a></li></ul></div></div> <div class=\"filter-row-right\" data-v-74d30af8><div class=\"filter-pill\" data-v-74d30af8><span class=\"filter-label\" data-v-74d30af8>All feeders</span> <i class=\"material-icons filter-arrow\" data-v-74d30af8>arrow_drop_down</i></div> <div class=\"filter-pill\" data-v-74d30af8><span class=\"filter-label\" data-v-74d30af8>Date</span> <i class=\"material-icons\" style=\"font-size:18px; color:#888;\" data-v-74d30af8>calendar_today</i></div></div> "), _vm._ssrNode("<div id=\"dashboard\" class=\"row\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel stats-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"valign-wrapper\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"icon-circle orange\" data-v-74d30af8><i class=\"material-icons white-text\" data-v-74d30af8>bolt</i></div> "), _vm._ssrNode("<div class=\"stats-text\" data-v-74d30af8>", "</div>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.energy_total
    }
  }), _vm._ssrNode(" <p class=\"grey-text\" data-v-74d30af8>Total Energy (MWh)</p>")], 2), _vm._ssrNode(" <span class=\"badge green white-text\" data-v-74d30af8>+13.6% ↑</span>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel stats-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"valign-wrapper\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"icon-circle red darken-2\" data-v-74d30af8><i class=\"material-icons white-text\" data-v-74d30af8>router</i></div> "), _vm._ssrNode("<div class=\"stats-text\" data-v-74d30af8>", "</div>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.total_feeders
    }
  }), _vm._ssrNode(" <p class=\"grey-text\" data-v-74d30af8>Total Feeders</p>")], 2), _vm._ssrNode(" <span class=\"badge green white-text\" data-v-74d30af8>+3.6% ↑</span>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel stats-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"valign-wrapper\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"icon-circle green\" data-v-74d30af8><i class=\"material-icons white-text\" data-v-74d30af8>battery_charging_full</i></div> "), _vm._ssrNode("<div class=\"stats-text\" data-v-74d30af8>", "</div>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.total_flagged
    }
  }), _vm._ssrNode(" <p class=\"grey-text\" data-v-74d30af8>Total flagged IDB meters</p>")], 2), _vm._ssrNode(" <span class=\"badge green white-text\" data-v-74d30af8>+13.6% ↑</span>")], 2)])])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-74d30af8>Feeder - to - DT Loss</p> "), _vm._ssrNode("<h5 data-v-74d30af8>", "</h5>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.feeder_loss
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<p class=\"tiny-text grey-text\" data-v-74d30af8>", "</p>", [_vm._ssrNode("Loss (%) "), _vm._ssrNode("<span class=\"right\" data-v-74d30af8>", "</span>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.feeder_loss_pct
    }
  })], 1)], 2), _vm._ssrNode(" <div class=\"progress red lighten-4\" data-v-74d30af8><div class=\"determinate red\"" + _vm._ssrStyle(null, {
    width: _vm.feeder_loss_pct
  }, null) + " data-v-74d30af8></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-74d30af8>Billing Efficiency</p> "), _vm._ssrNode("<p class=\"tiny-text grey-text\" data-v-74d30af8>", "</p>", [_vm._ssrNode("Billing Efficiency "), _vm._ssrNode("<span class=\"right\" data-v-74d30af8>", "</span>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.billing_eff
    }
  })], 1)], 2), _vm._ssrNode(" <div class=\"progress green lighten-4\" data-v-74d30af8><div class=\"determinate green\"" + _vm._ssrStyle(null, {
    width: _vm.billing_eff
  }, null) + " data-v-74d30af8></div></div>")], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-74d30af8>Customer - to - DT Loss</p> "), _vm._ssrNode("<h5 data-v-74d30af8>", "</h5>", [_c('AnimatedValue', {
    attrs: {
    ...
    width: _vm.customer_loss_pct
  }, null) + " data-v-74d30af8></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-74d30af8>ATC &amp; C</p> "), _vm._ssrNode("<p class=\"tiny-text grey-text\" data-v-74d30af8>", "</p>", [_vm._ssrNode("ATC &amp; C "), _vm._ssrNode("<span class=\"right\" data-v-74d30af8>", "</span>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.atc_c
    }
  })], 1)], 2), _vm._ssrNode(" <div class=\"progress light-blue lighten-4\" data-v-74d30af8><div class=\"determinate light-blue\"" + _vm._ssrStyle(null, {
    width: _vm.atc_c
  }, null) + " data-v-74d30af8></div></div>")], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel dt-summary-card mini-chart-card\" style=\"padding-bottom: 82px\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"row center-align\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<h3 data-v-74d30af8>", "</h3>", [_vm._ssrNode("<div class=\"icon-circle red darken-2\" style=\"margin: 0 auto;\" data-v-74d30af8><i class=\"material-icons white-text\" data-v-74d30af8>router</i></div> "), _c('AnimatedValue', {
    attrs: {
      "value": _vm.total_dts
    }
  })], 2), _vm._ssrNode(" <p class=\"grey-text\" data-v-74d30af8>Total DTs</p> <div class=\"divider\" data-v-74d30af8></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6 border-right\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<h5 data-v-74d30af8>", "</h5>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.public_dts
    }
  })], 1), _vm._ssrNode(" <p class=\"grey-text\" data-v-74d30af8>Public</p>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<h5 data-v-74d30af8>", "</h5>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.private_dts
    }
  })], 1), _vm._ssrNode(" <p class=\"grey-text\" data-v-74d30af8>Private</p>")], 2)], 2)])])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"col s12 m3\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2 center\" data-v-74d30af8>Total Customers</p> "), _vm.doughnutData ? _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
  ...
  }) : _vm._e(), _vm._ssrNode(" <div class=\"chart-legend-list\" data-v-74d30af8>" + _vm._ssrList(_vm.customerLegend, function (item) {
    return "<div class=\"cleg-item\" data-v-74d30af8><span class=\"cleg-dot\"" + _vm._ssrStyle(null, {
      backgroundColor: item.color
    }, null) + " data-v-74d30af8></span> <span class=\"cleg-label\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(item.label)) + "</span> <span class=\"cleg-val\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(item.value)) + "</span></div>";
  }) + "</div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2 center\" data-v-74d30af8>Revenue</p> "), _vm.revenueData ? _c('ChartPie', {
    attrs: {
      "chart-type": "pie",
      "chart-data": _vm.revenueData,
      "chart-options": _vm.pieOptions
    }
  }) : _vm._e(), _vm._ssrNode(" <div class=\"chart-legend-list\" data-v-74d30af8>" + _vm._ssrList(_vm.revenueLegend, function (item) {
    return "<div class=\"cleg-item\" data-v-74d30af8><span class=\"cleg-dot\"" + _vm._ssrStyle(null, {
      backgroundColor: item.color
    }, null) + " data-v-74d30af8></span> <span class=\"cleg-label\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(item.label)) + "</span> <span class=\"cleg-val\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(item.value)) + "</span></div>";
  }) + "</div>")], 2)]), _vm._ssrNode(" <div class=\"col s12 m3\" data-v-74d30af8><div class=\"card-panel mini-chart-card\" style=\"padding-bottom: 115px;\" data-v-74d30af8><p class=\"grey-text text-darken-2 center\" data-v-74d30af8>Energy</p> <div class=\"progress green lighten-4\" data-v-74d30af8><div class=\"determinate blue\"" + _vm._ssrStyle(null, {
    width: _vm.md_energy
  }, null) + " data-v-74d30af8></div></div> <div class=\"progress green lighten-4\" data-v-74d30af8><div class=\"determinate green\"" + _vm._ssrStyle(null, {
    width: _vm.nmd_energy
  }, null) + " data-v-74d30af8></div></div> <div class=\"col s6\" data-v-74d30af8><p data-v-74d30af8><span class=\"circle blue\" style=\"width: 10px; height: 10px; display: inline-block; margin-left: 5px;\" data-v-74d30af8></span> <span style=\"font-size: 12px;\" data-v-74d30af8>MD Energy</span> <span data-v-74d30af8>336.79</span> <span data-v-74d30af8>80.93%</span></p></div> <div class=\"col s6\" data-v-74d30af8><p data-v-74d30af8><span class=\"circle green\" style=\"width: 10px; height: 10px; display: inline-block; margin-left: 5px;\" data-v-74d30af8></span> <span style=\"font-size: 12px;\" data-v-74d30af8>NMD Energy</span> <span data-v-74d30af8>1,429.65k</span> <span data-v-74d30af8>19.07%</span></p></div></div></div> "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" style=\"padding-bottom: 60px;\" data-v-74d30af8>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2 center\" data-v-74d30af8>Meter Communication</p> "), _c('MeterCommunication', {
    attrs: {
      "percentage": _vm.meterValue
    }
  })], 2)])], 2)], 2), _vm._ssrNode(" <div id=\"feeder-loss\" class=\"row\" data-v-74d30af8><div class=\"col s12\" data-v-74d30af8><div class=\"table-wrapper\" data-v-74d30af8><table class=\"rounded-header striped highlight\" data-v-74d30af8><thead class=\"orange white-text\" style=\"border: 1px solid #ff9800;\" data-v-74d30af8><tr data-v-74d30af8><th data-v-74d30af8>Feeder</th> <th data-v-74d30af8>Date</th> <th data-v-74d30af8>Band</th> <th data-v-74d30af8>Total Public DTs</th> <th data-v-74d30af8>Public DTs</th> <th data-v-74d30af8>Total Private DTs</th> <th data-v-74d30af8>Private DTs Energy</th> <th data-v-74d30af8>Total DT Energy</th> <th data-v-74d30af8>Feeder Energy</th> <th data-v-74d30af8>Feeder to DT Loss</th> <th data-v-74d30af8>Feeder Loss</th></tr></thead> <tbody data-v-74d30af8>" + _vm._ssrList(_vm.feeder_to_dt_loss_data, function (value) {
    return "<tr data-v-74d30af8><td style=\"font-size: 12px; font-weight: 600;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.feeder)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.date)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.band)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.total_public_dts)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.public_dts)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.total_private_dts)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.private_dts_energy)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.total_dt_energy)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.feeder_energy)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.feeder_to_dt_loss)) + "</td> <td style=\"font-size: 12px;\" data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.feeder_loss)) + "</td></tr>";
  }) + "</tbody></table></div></div></div> <div id=\"customer-loss\" class=\"row\" data-v-74d30af8><div class=\"col s12\" data-v-74d30af8><div class=\"table-wrapper\" data-v-74d30af8><table class=\"rounded-header2 striped highlight\" data-v-74d30af8><thead class=\"red-accent-4 white-text\" style=\"border: 1px solid #ff9800;\" data-v-74d30af8><tr data-v-74d30af8><th data-v-74d30af8>Feeders</th> <th data-v-74d30af8>All Customers</th> <th data-v-74d30af8>Post MD</th> <th data-v-74d30af8>Comms %</th> <th data-v-74d30af8>Total Meters Communicating</th> <th data-v-74d30af8>Prepaid MD</th> <th data-v-74d30af8>IDB Prepay</th> <th data-v-74d30af8>DT Consumption</th> <th data-v-74d30af8>IDB Prepay Consumption</th> <th data-v-74d30af8>MD Prepay Consumption</th> <th data-v-74d30af8>Postpaid Consumption</th> <th data-v-74d30af8>IDB MD Consumption</th> <th data-v-74d30af8>CE</th> <th data-v-74d30af8>BE</th> <th data-v-74d30af8>ATC</th> <th data-v-74d30af8>Current Loss</th> <th data-v-74d30af8>Customer to DT Loss</th></tr></thead> <tbody data-v-74d30af8>" + _vm._ssrList(_vm.customer_loss_pct_data, function (value) {
    return "<tr data-v-74d30af8><td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.feeder)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.all_customers)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.post_md)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.comms_pct)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.total_meters_communicating)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.prepaid_md)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.idb_prepay)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.dt_consumption)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.idb_prepay_consumption)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.md_prepay_consumption)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.postpaid_consumption)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.idb_md_consumption)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.ce)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.be)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.atc)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.current_loss)) + "</td> <td data-v-74d30af8>" + _vm._ssrEscape(_vm._s(value.customer_to_dt_loss)) + "</td></tr>";
  }) + "</tbody></table></div></div></div>")], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/idb_dashboard.vue?vue&type=template&id=74d30af8&scoped=true
