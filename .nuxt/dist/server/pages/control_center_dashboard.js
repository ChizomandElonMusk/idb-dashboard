...
module.exports.__inject__ = function (context) {
  add("4b0e59ac", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_1a3f1853_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(117);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_1a3f1853_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_1a3f1853_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_1a3f1853_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_1a3f1853_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-1a3f1853]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-1a3f1853]{min-height:100vh;padding-left:280px;padding-right:20px;padding-top:20px;position:relative}.avail-header[data-v-1a3f1853]{align-items:center;display:flex;justify-content:space-between;margin-bottom:20px}.avail-title[data-v-1a3f1853]{color:var(--text-primary);font-weight:600;margin:0}.top-stat-card[data-v-1a3f1853]{background:var(--bg-card);border-radius:14px;margin-bottom:12px;padding:18px 16px 14px}.top-stat-header[data-v-1a3f1853]{align-items:flex-start;display:flex;gap:12px;margin-bottom:14px}.top-stat-icon-wrap[data-v-1a3f1853]{align-items:center;border-radius:50%;display:flex;flex-shrink:0;height:46px;justify-content:center;width:46px}.red-icon-wrap[data-v-1a3f1853]{background-color:#fdeaeb}.blue-icon-wrap[data-v-1a3f1853]{background-color:#eaedff}.top-stat-icon[data-v-1a3f1853]{font-size:22px!important}.red-icon[data-v-1a3f1853]{color:#c0392b}.blue-icon[data-v-1a3f1853]{color:#4a5fa5}.top-stat-info[data-v-1a3f1853]{flex:1}.top-stat-value[data-v-1a3f1853]{color:var(--text-primary);font-size:26px;font-weight:700;line-height:1.1;margin:0 0 2px}.top-stat-label[data-v-1a3f1853]{color:var(--text-muted);font-size:12px;margin:0}.top-stat-divider[data-v-1a3f1853]{background:var(--divider);height:1px;margin-bottom:12px}.top-stat-sub-row[data-v-1a3f1853]{display:flex}.top-stat-sub[data-v-1a3f1853]{flex:1;text-align:center}.sub-label[data-v-1a3f1853]{color:var(--text-muted);font-size:12px;margin:0 0 2px}.sub-value[data-v-1a3f1853]{color:var(--text-primary);font-size:20px;font-weight:700;margin:0}.border-right[data-v-1a3f1853]{border-right:1px solid var(--border-color)}.customers-card-title[data-v-1a3f1853]{color:var(--text-secondary);font-size:13px;font-weight:600;margin:0 0 14px;text-align:center}.progress-item[data-v-1a3f1853]{margin-bottom:4px}.progress-label-row[data-v-1a3f1853]{align-items:center;display:flex;justify-content:space-between;margin-bottom:4px}.progress-name[data-v-1a3f1853]{color:var(--text-secondary);font-size:12px}.progress-fraction[data-v-1a3f1853]{color:var(--text-muted);font-size:11px}.mini-chart-card[data-v-1a3f1853]{background:var(--bg-card);border-radius:14px;margin-bottom:12px;padding:20px}.energy-card-header[data-v-1a3f1853]{align-items:center;display:flex;justify-content:space-between;margin-bottom:4px}.energy-card-title[data-v-1a3f1853]{color:var(--text-primary);font-size:15px;font-weight:600;margin:0}.energy-card-value[data-v-1a3f1853]{color:var(--text-primary);font-size:22px;font-weight:700;margin:0 0 8px}.chart-tabs[data-v-1a3f1853]{align-items:center;display:flex;gap:14px}.chart-tab[data-v-1a3f1853]{color:var(--text-muted);cursor:pointer;font-size:13px;padding:4px 6px}.chart-tab.active[data-v-1a3f1853]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary);font-weight:600;padding:4px 10px}.chart-icon-btn[data-v-1a3f1853]{align-items:center;background:rgba(0,0,0,.05);background:var(--bg-card-alt,rgba(0,0,0,.05));border-radius:6px;color:var(--text-muted);display:flex;height:26px;justify-content:center;width:26px}.chart-icon-btn-accent[data-v-1a3f1853]{background:#d7f5e3;color:#27ae60}.chart-callout-wrap[data-v-1a3f1853]{position:relative}.chart-callout[data-v-1a3f1853]{background:var(--bg-card);border:1px solid var(--border-color);border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,.08);box-shadow:0 2px 8px var(--shadow-color,rgba(0,0,0,.08));display:flex;flex-direction:column;line-height:1.3;padding:6px 12px;pointer-events:none;position:absolute}.callout-title[data-v-1a3f1853]{color:var(--text-muted);font-size:11px}.callout-value[data-v-1a3f1853]{color:var(--text-primary);font-size:13px;font-weight:700}.pie-card-title[data-v-1a3f1853]{color:var(--text-secondary);font-size:13px;font-weight:600;margin:0 0 10px}.band-pct-legend[data-v-1a3f1853]{display:flex;flex-wrap:wrap;gap:10px;justify-content:center;margin-top:10px}.band-pct-item[data-v-1a3f1853]{font-size:12px;font-weight:700}.vending-stats-grid[data-v-1a3f1853]{border-top:1px solid var(--divider);display:flex;gap:20px;margin-top:14px;padding-top:12px}.vending-stats-col[data-v-1a3f1853]{display:flex;flex:1;flex-direction:column;gap:8px}.vending-stat-row[data-v-1a3f1853]{align-items:center;display:flex;font-size:12px;gap:8px}.vstat-dot[data-v-1a3f1853]{border-radius:50%;flex-shrink:0;height:10px;width:10px}.vstat-dot-green[data-v-1a3f1853]{background-color:#4ecb71}.vstat-dot-blue[data-v-1a3f1853]{background-color:#5b7cfa}.vstat-label[data-v-1a3f1853]{color:var(--text-secondary);flex:1}.vstat-value[data-v-1a3f1853]{color:var(--text-primary);font-weight:700;white-space:nowrap}.cc-error[data-v-1a3f1853]{align-items:center;background:#fdecec;border-radius:10px;color:#c0392b;display:flex;font-size:13px;gap:12px;margin-bottom:16px;padding:10px 16px}.cc-retry[data-v-1a3f1853]{background:#c0392b;border:none;border-radius:6px;color:#fff;cursor:pointer;font-size:12px;padding:4px 12px}@media only screen and (max-width:992px){.main-content[data-v-1a3f1853]{padding-left:20px}}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/control_center_dashboard.vue?vue&type=template&id=1a3f1853&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-1a3f1853>", "</main>", [_c('LoadingOverlay', {
    attrs: {
      "visible": _vm.loading
    }
  }), _vm._ssrNode(" <div class=\"avail-header\" data-v-1a3f1853><h5 class=\"avail-title\" data-v-1a3f1853>Control Center Dashboard</h5></div> " + (_vm.error ? "<div class=\"cc-error\" data-v-1a3f1853>" + _vm._ssrEscape("\n            Couldn't load live data: " + _vm._s(_vm.error) + "\n            ") + "<button class=\"cc-retry\" data-v-1a3f1853>Retry</button></div>" : "<!---->") + " "), _vm._ssrNode("<div class=\"row\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"col s12 m3\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"top-stat-header\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"top-stat-icon-wrap red-icon-wrap\" data-v-1a3f1853><i class=\"material-icons top-stat-icon red-icon\" data-v-1a3f1853>device_hub</i></div> "), _vm._ssrNode("<div class=\"top-stat-info\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<p class=\"top-stat-value\" data-v-1a3f1853>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.online_feeders
    }
  })], 1), _vm._ssrNode(" <p class=\"top-stat-label\" data-v-1a3f1853>Online feeders</p>")], 2)], 2), _vm._ssrNode(" <div class=\"top-stat-divider\" data-v-1a3f1853></div> <div class=\"top-stat-sub-row\" data-v-1a3f1853><div class=\"top-stat-sub border-right\" data-v-1a3f1853><p class=\"sub-label\" data-v-1a3f1853>11kv</p> <p class=\"sub-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.kv11)) + "</p></div> <div class=\"top-stat-sub\" data-v-1a3f1853><p class=\"sub-label\" data-v-1a3f1853>33kv</p> <p class=\"sub-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.kv33)) + "</p></div></div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"top-stat-header\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"top-stat-icon-wrap red-icon-wrap\" data-v-1a3f1853><i class=\"material-icons top-stat-icon red-icon\" data-v-1a3f1853>bolt</i></div> "), _vm._ssrNode("<div class=\"top-stat-info\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<p class=\"top-stat-value\" data-v-1a3f1853>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.online_dts
    }
  })], 1), _vm._ssrNode(" <p class=\"top-stat-label\" data-v-1a3f1853>Online DTs</p>")], 2)], 2), _vm._ssrNode(" <div class=\"top-stat-divider\" data-v-1a3f1853></div> <div class=\"top-stat-sub-row\" data-v-1a3f1853><div class=\"top-stat-sub border-right\" data-v-1a3f1853><p class=\"sub-label\" data-v-1a3f1853>Public</p> <p class=\"sub-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.public_dts)) + "</p></div> <div class=\"top-stat-sub\" data-v-1a3f1853><p class=\"sub-label\" data-v-1a3f1853>Private</p> <p class=\"sub-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.private_dts)) + "</p></div></div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"top-stat-header\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"top-stat-icon-wrap blue-icon-wrap\" data-v-1a3f1853><i class=\"material-icons top-stat-icon blue-icon\" data-v-1a3f1853>group</i></div> "), _vm._ssrNode("<div class=\"top-stat-info\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<p class=\"top-stat-value\" data-v-1a3f1853>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.complaints_total
    }
  })], 1), _vm._ssrNode(" <p class=\"top-stat-label\" data-v-1a3f1853>Total Customer Complaints</p>")], 2)], 2), _vm._ssrNode(" <div class=\"top-stat-divider\" data-v-1a3f1853></div> <div class=\"top-stat-sub-row\" data-v-1a3f1853><div class=\"top-stat-sub border-right\" data-v-1a3f1853><p class=\"sub-label\" data-v-1a3f1853>Open</p> <p class=\"sub-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.complaints_open)) + "</p></div> <div class=\"top-stat-sub\" data-v-1a3f1853><p class=\"sub-label\" data-v-1a3f1853>Closed</p> <p class=\"sub-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.complaints_closed)) + "</p></div></div>")], 2)]), _vm._ssrNode(" <div class=\"col s12 m3\" data-v-1a3f1853><div class=\"card-panel top-stat-card\" data-v-1a3f1853><p class=\"customers-card-title\" data-v-1a3f1853>Total Customers</p> <div class=\"progress-item\" data-v-1a3f1853><div class=\"progress-label-row\" data-v-1a3f1853><span class=\"progress-name\" data-v-1a3f1853>Metered NMD</span> <span class=\"progress-fraction\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.nmd_value) + "/" + _vm._s(_vm.nmd_total)) + "</span></div> <div class=\"progress indigo lighten-4\" style=\"height:8px; border-radius:4px;\" data-v-1a3f1853><div class=\"determinate indigo accent-2\"" + _vm._ssrStyle(null, {
    width: _vm.nmd_pct
  }, null) + " data-v-1a3f1853></div></div></div> <div class=\"progress-item\" style=\"margin-top: 14px;\" data-v-1a3f1853><div class=\"progress-label-row\" data-v-1a3f1853><span class=\"progress-name\" data-v-1a3f1853>Metered MD</span> <span class=\"progress-fraction\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.md_value) + "/" + _vm._s(_vm.md_total)) + "</span></div> <div class=\"progress green lighten-4\" style=\"height:8px; border-radius:4px;\" data-v-1a3f1853><div class=\"determinate green\"" + _vm._ssrStyle(null, {
    width: _vm.md_pct
  }, null) + " data-v-1a3f1853></div></div></div></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"col s12 m7\" data-v-1a3f1853><div class=\"card-panel mini-chart-card energy-card\" data-v-1a3f1853><div class=\"energy-card-header\" data-v-1a3f1853><p class=\"energy-card-title\" data-v-1a3f1853>Energy</p> <div class=\"chart-tabs\" data-v-1a3f1853><span class=\"chart-tab active\" data-v-1a3f1853>Month</span> <span class=\"chart-icon-btn\" data-v-1a3f1853><i class=\"material-icons tiny\" data-v-1a3f1853>calendar_today</i></span> <span class=\"chart-icon-btn chart-icon-btn-accent\" data-v-1a3f1853><i class=\"material-icons tiny\" data-v-1a3f1853>description</i></span></div></div> <p class=\"energy-card-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.energyTotal)) + "</p> <div class=\"chart-callout-wrap\" data-v-1a3f1853><div style=\"position: relative; height:190px;\" data-v-1a3f1853><canvas id=\"energyChart\" data-v-1a3f1853></canvas></div> " + (_vm.energyCallout ? "<div class=\"chart-callout\"" + _vm._ssrStyle(null, {
    left: _vm.energyCallout.leftPct + '%',
    top: '6px'
  }, null) + " data-v-1a3f1853><span class=\"callout-title\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.energyCallout.title)) + "</span> <span class=\"callout-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.energyCallout.value)) + "</span></div>" : "<!---->") + "</div></div></div> "), _vm._ssrNode("<div class=\"col s12 m5\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<p class=\"pie-card-title center\" data-v-1a3f1853>Energy Allocation per Feeder Band</p> "), _c('ChartPie', {
    attrs: {
      "chart-type": "pie",
      "chart-data": _vm.energyAllocationData,
      "chart-options": _vm.pieOptions
    }
  }), _vm._ssrNode(" <div class=\"band-pct-legend\" data-v-1a3f1853>" + _vm._ssrList(_vm.bandPctLegend, function (item) {
    return "<span class=\"band-pct-item\"" + _vm._ssrStyle(null, {
      color: item.color
    }, null) + " data-v-1a3f1853>" + _vm._ssrEscape("\n                            " + _vm._s(item.label) + " " + _vm._s(item.pct) + "\n                        ") + "</span>";
  }) + "</div>")], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"col s12 m7\" data-v-1a3f1853><div class=\"card-panel mini-chart-card energy-card\" data-v-1a3f1853><div class=\"energy-card-header\" data-v-1a3f1853><p class=\"energy-card-title\" data-v-1a3f1853>Vending &amp; Collection</p> <div class=\"chart-tabs\" data-v-1a3f1853><span" + _vm._ssrClass("chart-tab", {
    active: _vm.vendingTab === 'Day'
  }) + " data-v-1a3f1853>Day</span> <span" + _vm._ssrClass("chart-tab", {
    active: _vm.vendingTab === 'Week'
  }) + " data-v-1a3f1853>Week</span> <span" + _vm._ssrClass("chart-tab", {
    active: _vm.vendingTab === 'Month'
  }) + " data-v-1a3f1853>Month</span> <span class=\"chart-icon-btn\" data-v-1a3f1853><i class=\"material-icons tiny\" data-v-1a3f1853>calendar_today</i></span></div></div> <div class=\"chart-callout-wrap\" data-v-1a3f1853><div style=\"position: relative; height:190px;\" data-v-1a3f1853><canvas id=\"vendingChart\" data-v-1a3f1853></canvas></div> " + (_vm.vendingCallout ? "<div class=\"chart-callout\"" + _vm._ssrStyle(null, {
    left: _vm.vendingCallout.leftPct + '%',
    top: '6px'
  }, null) + " data-v-1a3f1853><span class=\"callout-title\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.vendingCallout.title)) + "</span> <span class=\"callout-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.vendingCallout.value)) + "</span></div>" : "<!---->") + "</div> <div class=\"vending-stats-grid\" data-v-1a3f1853><div class=\"vending-stats-col\" data-v-1a3f1853><div class=\"vending-stat-row\" data-v-1a3f1853><span class=\"vstat-dot vstat-dot-green\" data-v-1a3f1853></span> <span class=\"vstat-label\" data-v-1a3f1853>Total customer Vended Today</span> <span class=\"vstat-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.vendingStats.customerVendedToday)) + "</span></div> <div class=\"vending-stat-row\" data-v-1a3f1853><span class=\"vstat-dot vstat-dot-green\" data-v-1a3f1853></span> <span class=\"vstat-label\" data-v-1a3f1853>Amount Vended Today</span> <span class=\"vstat-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.vendingStats.amountVendedToday)) + "</span></div> <div class=\"vending-stat-row\" data-v-1a3f1853><span class=\"vstat-dot vstat-dot-green\" data-v-1a3f1853></span> <span class=\"vstat-label\" data-v-1a3f1853>Amount Vended MTD</span> <span class=\"vstat-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.vendingStats.amountVendedMtd)) + "</span></div></div> <div class=\"vending-stats-col\" data-v-1a3f1853><div class=\"vending-stat-row\" data-v-1a3f1853><span class=\"vstat-dot vstat-dot-blue\" data-v-1a3f1853></span> <span class=\"vstat-label\" data-v-1a3f1853>Total Collection Today</span> <span class=\"vstat-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.vendingStats.totalCollectionToday)) + "</span></div> <div class=\"vending-stat-row\" data-v-1a3f1853><span class=\"vstat-dot vstat-dot-blue\" data-v-1a3f1853></span> <span class=\"vstat-label\" data-v-1a3f1853>Amount Collected MTD</span> <span class=\"vstat-value\" data-v-1a3f1853>" + _vm._ssrEscape(_vm._s(_vm.vendingStats.amountCollectedMtd)) + "</span></div></div></div></div></div> "), _vm._ssrNode("<div class=\"col s12 m5\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-1a3f1853>", "</div>", [_vm._ssrNode("<p class=\"pie-card-title center\" data-v-1a3f1853>Total Feeder</p> "), _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
      "chart-data": _vm.totalFeederData,
      "chart-options": _vm.doughnutOptions,
      "center-text": _vm.totalFeederCenterText,
...
// CONCATENATED MODULE: ./pages/control_center_dashboard.vue?vue&type=template&id=1a3f1853&scoped=true
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/control_center_dashboard.vue?vue&type=script&lang=js
...
/* harmony default export */ var control_center_dashboardvue_type_script_lang_js = ({
  components: {
  ...
  methods: {
    async loadSummary() {
      ...
      this.error = null;
      try {
        const data = await Object(controlCenterApi["j" /* getControlCenterSummary */])();
    ...
    applySummary(data) {
      ...
      this.online_feeders = Object(controlCenterApi["g" /* formatNumber */])(feeder.online_feeders);
      this.kv11 = Object(controlCenterApi["g" /* formatNumber */])(feeder.online_feeders_11kv);
      this.kv33 = Object(controlCenterApi["g" /* formatNumber */])(feeder.online_feeders_33kv);
      this.online_dts = Object(controlCenterApi["g" /* formatNumber */])(feeder.online_dts);
      this.public_dts = Object(controlCenterApi["g" /* formatNumber */])(feeder.online_dts_public);
      this.private_dts = Object(controlCenterApi["g" /* formatNumber */])(feeder.online_dts_private);
      ...
      this.complaints_total = Object(controlCenterApi["g" /* formatNumber */])(complaints.total);
      this.complaints_open = Object(controlCenterApi["g" /* formatNumber */])(complaints.open);
      this.complaints_closed = Object(controlCenterApi["g" /* formatNumber */])(complaints.closed);
      const customers = data.customers || {};
      this.nmd_value = Object(controlCenterApi["g" /* formatNumber */])(customers.metered_nmd_actual);
      this.nmd_total = Object(controlCenterApi["g" /* formatNumber */])(customers.metered_nmd_target);
      this.nmd_pct = pctString(customers.metered_nmd_actual, customers.metered_nmd_target);
      this.md_value = Object(controlCenterApi["g" /* formatNumber */])(customers.metered_md_actual);
      this.md_total = Object(controlCenterApi["g" /* formatNumber */])(customers.metered_md_target);
      this.md_pct = pctString(customers.metered_md_actual, customers.metered_md_target);
      const energy = data.energy || {};
      this.energyTotal = `${Object(controlCenterApi["g" /* formatNumber */])(energy.total_mwh)}MWh`;
      const energyTrend = energy.trend || [];
      this.energyChartLabels = energyTrend.map(t => Object(controlCenterApi["s" /* monthLabel */])(t.date));
      this.energyChartValues = energyTrend.map(t => t.mwh);
      this.energyCallout = Object(controlCenterApi["e" /* buildTrendCallout */])(energyTrend, 'mwh', t => Object(controlCenterApi["s" /* monthLabel */])(t.date), v => `${Object(controlCenterApi["g" /* formatNumber */])(v)} MWh`);
      const allocation = data.energy_allocation_by_band || [];
      this.bandPctLegend = allocation.map(a => ({
        label: a.band,
        pct: `${a.pct}%`,
        color: Object(controlCenterApi["d" /* bandColor */])(a.band)
      }));
      this.energyAllocationData = {
        labels: allocation.map(a => a.band),
        datasets: [{
          data: allocation.map(a => a.pct),
          backgroundColor: allocation.map(a => Object(controlCenterApi["d" /* bandColor */])(a.band)),
          borderWidth: 0
        }]
      };
      const vending = data.vending_collection || {};
      this.vendingStats = {
        customerVendedToday: Object(controlCenterApi["g" /* formatNumber */])(vending.customer_vended_today),
        amountVendedToday: Object(controlCenterApi["g" /* formatNumber */])(vending.amount_vended_today),
        amountVendedMtd: Object(controlCenterApi["g" /* formatNumber */])(vending.amount_vended_mtd),
        totalCollectionToday: Object(controlCenterApi["g" /* formatNumber */])(vending.total_collection_today),
        amountCollectedMtd: Object(controlCenterApi["g" /* formatNumber */])(vending.amount_collected_mtd)
      };
      this.vendingRawTrend = vending.trend || [];
      this.updateVendingView();
      const feedersByBand = data.feeders_by_band || {};
      this.totalFeederCenterText = Object(controlCenterApi["g" /* formatNumber */])(feedersByBand.total);
      const breakdown = feedersByBand.breakdown || [];
      this.totalFeederData = {
        labels: breakdown.map(b => `Band ${b.band}`),
        datasets: [{
          data: breakdown.map(b => b.count),
          backgroundColor: breakdown.map(b => Object(controlCenterApi["d" /* bandColor */])(b.band)),
          borderWidth: 0
        }]
      };
      this.$nextTick(() => {
    ...
    updateVendingView() {
      const points = Object(controlCenterApi["c" /* aggregateDailyTrend */])(this.vendingRawTrend, this.vendingTab, ['vended', 'collected']);
      ...
      this.vendingCallout = Object(controlCenterApi["e" /* buildTrendCallout */])(points, 'vended', p => p.label, v => Object(controlCenterApi["g" /* formatNumber */])(v));
    },
    setVendingTab(tab) {
      this.vendingTab = tab;
      this.updateVendingView();
    ...
    initEnergyChart() {
      ...
      this.energyChart = new Chart_default.a(canvas.getContext('2d'), {
        type: 'line',
        data: {
    ...
    initVendingChart() {
      ...
      this.vendingChart = new Chart_default.a(canvas.getContext('2d'), {
        type: 'line',
        data: {
...
// CONCATENATED MODULE: ./pages/control_center_dashboard.vue?vue&type=script&lang=js
 /* harmony default export */ var pages_control_center_dashboardvue_type_script_lang_js = (control_center_dashboardvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/control_center_dashboard.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_control_center_dashboardvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var control_center_dashboard = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {SideNav: __webpack_require__(78).default,LoadingOverlay: __webpack_require__(80).default,AnimatedValue: __webpack_require__(82).default,ChartPie: __webpack_require__(90).default})
...
//# sourceMappingURL=control_center_dashboard.js.map