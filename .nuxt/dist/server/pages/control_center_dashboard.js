...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("2ae76bca", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_359e604c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_359e604c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_359e604c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_359e604c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_control_center_dashboard_vue_vue_type_style_index_0_id_359e604c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-359e604c]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-359e604c]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-header[data-v-359e604c]{align-items:center;display:flex;justify-content:space-between;margin-bottom:20px}.avail-title[data-v-359e604c]{color:var(--text-primary);font-weight:600;margin:0}.state-panel[data-v-359e604c]{align-items:center;display:flex;flex-direction:column;gap:12px;justify-content:center;padding:60px 20px}.state-message[data-v-359e604c]{color:var(--text-secondary);text-align:center}.retry-btn[data-v-359e604c]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary)}.pending-note[data-v-359e604c]{color:var(--text-muted);font-size:12px;margin:8px 0 0}.pending-card[data-v-359e604c]{padding:20px;text-align:center}.loss-row[data-v-359e604c]{align-items:center;display:flex;gap:8px;margin-top:4px}.loss-label[data-v-359e604c]{color:var(--text-muted);font-size:11px}.top-cards-row[data-v-359e604c]{margin-bottom:0}.top-stat-card[data-v-359e604c]{background:var(--bg-card);border-radius:14px;margin-bottom:12px;padding:18px 16px 14px}.top-stat-header[data-v-359e604c]{align-items:flex-start;display:flex;gap:12px;margin-bottom:14px}.top-stat-icon-wrap[data-v-359e604c]{align-items:center;border-radius:10px;display:flex;flex-shrink:0;height:46px;justify-content:center;width:46px}.red-icon-wrap[data-v-359e604c]{background-color:#fdeaeb}.blue-icon-wrap[data-v-359e604c]{background-color:#eaedff}.top-stat-icon[data-v-359e604c]{font-size:22px!important}.red-icon[data-v-359e604c]{color:#c0392b}.blue-icon[data-v-359e604c]{color:#4a5fa5}.top-stat-info[data-v-359e604c]{flex:1}.top-stat-value[data-v-359e604c]{color:var(--text-primary);font-size:28px;font-weight:700;line-height:1.1;margin:0 0 2px}.top-stat-label[data-v-359e604c]{color:var(--text-muted);font-size:12px;margin:0}.top-stat-divider[data-v-359e604c]{background:var(--divider);height:1px;margin-bottom:12px}.top-stat-sub-row[data-v-359e604c]{display:flex}.top-stat-sub[data-v-359e604c]{flex:1;text-align:center}.sub-label[data-v-359e604c]{color:var(--text-muted);font-size:12px;margin:0 0 2px}.sub-value[data-v-359e604c]{color:var(--text-primary);font-size:20px;font-weight:700;margin:0}.border-right[data-v-359e604c]{border-right:1px solid var(--border-color)}.customers-card-title[data-v-359e604c]{color:var(--text-secondary);font-size:13px;font-weight:600;margin:0 0 14px;text-align:center}.progress-item[data-v-359e604c]{margin-bottom:4px}.progress-label-row[data-v-359e604c]{align-items:center;display:flex;justify-content:space-between;margin-bottom:4px}.progress-name[data-v-359e604c]{color:var(--text-secondary);font-size:12px}.progress-fraction[data-v-359e604c]{color:var(--text-muted);font-size:11px}.mini-chart-card[data-v-359e604c]{background:var(--bg-card);border-radius:14px;margin-bottom:12px}.energy-card-header[data-v-359e604c]{align-items:flex-start;display:flex;justify-content:space-between;margin-bottom:8px}.energy-card-title[data-v-359e604c]{color:var(--text-primary);font-size:15px;font-weight:600;margin:0 0 2px}.energy-card-value[data-v-359e604c]{color:var(--text-primary);font-size:22px;font-weight:700;margin:0}.pie-card-title[data-v-359e604c]{color:var(--text-secondary);font-size:13px;font-weight:600;margin:0 0 10px}.vending-card-title[data-v-359e604c]{color:var(--text-primary);font-size:15px;font-weight:600;margin-right:8px}.vending-stats-grid[data-v-359e604c]{display:flex;gap:20px;margin-top:12px}.vending-stats-col[data-v-359e604c]{display:flex;flex:1;flex-direction:column;gap:8px}.vending-stat-row[data-v-359e604c]{font-size:12px;gap:8px}.vending-stat-row[data-v-359e604c],.vstat-dot[data-v-359e604c]{align-items:center;display:flex}.vstat-dot[data-v-359e604c]{border:2px solid;border-radius:50%;flex-shrink:0;height:14px;justify-content:center;width:14px}.vstat-dot[data-v-359e604c]:after{border-radius:50%;content:\"\";height:5px;width:5px}.vstat-dot-green[data-v-359e604c]{border-color:#5ebd8d}.vstat-dot-green[data-v-359e604c]:after{background-color:#5ebd8d}.vstat-dot-blue[data-v-359e604c]{border-color:#5b7cfa}.vstat-dot-blue[data-v-359e604c]:after{background-color:#5b7cfa}.vstat-label[data-v-359e604c]{color:var(--text-secondary);flex:1}.vstat-value[data-v-359e604c]{color:var(--text-primary);font-weight:700;white-space:nowrap}@media only screen and (max-width:992px){.main-content[data-v-359e604c]{padding-left:20px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/control_center_dashboard.vue?vue&type=template&id=359e604c&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-359e604c>", "</main>", [_vm._ssrNode("<div class=\"avail-header\" data-v-359e604c><h5 class=\"avail-title\" data-v-359e604c>Control Center Dashboard</h5></div> "), _vm.loading ? _vm._ssrNode("<div class=\"state-panel\" data-v-359e604c>", "</div>", [_c('PreLoader')], 1) : _vm.error ? _vm._ssrNode("<div class=\"state-panel\" data-v-359e604c><p class=\"state-message\" data-v-359e604c>" + _vm._ssrEscape("Could not load Control Center data: " + _vm._s(_vm.error)) + "</p> <button class=\"btn-flat retry-btn\" data-v-359e604c>Retry</button></div>") : _vm._ssrNode("<div id=\"dashboard\" class=\"row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"row top-cards-row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"col s12 m3\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"top-stat-header\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"top-stat-icon-wrap red-icon-wrap\" data-v-359e604c><i class=\"material-icons top-stat-icon red-icon\" data-v-359e604c>device_hub</i></div> "), _vm._ssrNode("<div class=\"top-stat-info\" data-v-359e604c>", "</div>", [_vm._ssrNode("<p class=\"top-stat-value\" data-v-359e604c>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.online_feeders
    }
  })], 1), _vm._ssrNode(" <p class=\"top-stat-label\" data-v-359e604c>Total feeders</p>")], 2)], 2), _vm._ssrNode(" <div class=\"top-stat-divider\" data-v-359e604c></div> <div class=\"top-stat-sub-row\" data-v-359e604c><div class=\"top-stat-sub border-right\" data-v-359e604c><p class=\"sub-label\" data-v-359e604c>11kv</p> <p class=\"sub-value\" data-v-359e604c>" + _vm._ssrEscape(_vm._s(_vm.kv11)) + "</p></div> <div class=\"top-stat-sub\" data-v-359e604c><p class=\"sub-label\" data-v-359e604c>33kv</p> <p class=\"sub-value\" data-v-359e604c>" + _vm._ssrEscape(_vm._s(_vm.kv33)) + "</p></div></div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"top-stat-header\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"top-stat-icon-wrap red-icon-wrap\" data-v-359e604c><i class=\"material-icons top-stat-icon red-icon\" data-v-359e604c>bolt</i></div> "), _vm._ssrNode("<div class=\"top-stat-info\" data-v-359e604c>", "</div>", [_vm._ssrNode("<p class=\"top-stat-value\" data-v-359e604c>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.online_dts
    }
  })], 1), _vm._ssrNode(" <p class=\"top-stat-label\" data-v-359e604c>Total DTs</p>")], 2)], 2), _vm._ssrNode(" <div class=\"top-stat-divider\" data-v-359e604c></div> "), _vm._ssrNode("<div class=\"top-stat-sub-row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"top-stat-sub border-right\" data-v-359e604c>", "</div>", [_vm._ssrNode("<p class=\"sub-label\" data-v-359e604c>Public</p> "), _vm._ssrNode("<p class=\"sub-value\" data-v-359e604c>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.public_dts
    }
  })], 1)], 2), _vm._ssrNode(" <div class=\"top-stat-sub\" data-v-359e604c><p class=\"sub-label\" data-v-359e604c>Private</p> <p class=\"sub-value\" data-v-359e604c>" + _vm._ssrEscape(_vm._s(_vm.private_dts)) + "</p></div>")], 2)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"top-stat-header\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"top-stat-icon-wrap blue-icon-wrap\" data-v-359e604c><i class=\"material-icons top-stat-icon blue-icon\" data-v-359e604c>group</i></div> "), _vm._ssrNode("<div class=\"top-stat-info\" data-v-359e604c>", "</div>", [_vm._ssrNode("<p class=\"top-stat-label\" style=\"margin-bottom: 6px;\" data-v-359e604c>Total Customer Complaints</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  })], 2)], 2), _vm._ssrNode(" <div class=\"top-stat-divider\" data-v-359e604c></div> <p class=\"pending-note\" data-v-359e604c>Complaints data pending source onboarding</p>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"card-panel top-stat-card\" data-v-359e604c>", "</div>", [_vm._ssrNode("<p class=\"customers-card-title\" data-v-359e604c>Total Customers</p> "), _vm._ssrNode("<div class=\"progress-item\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"progress-label-row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<span class=\"progress-name\" data-v-359e604c>NMD</span> "), _vm._ssrNode("<span class=\"progress-fraction\" data-v-359e604c>", "</span>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.nmd_value
    }
  }), _vm._ssrNode(_vm._ssrEscape("/" + _vm._s(_vm.total_customers_display) + "\n                                "))], 2)], 2), _vm._ssrNode(" <div class=\"progress indigo lighten-4\" style=\"height:8px; border-radius:4px;\" data-v-359e604c><div class=\"determinate indigo accent-2\"" + _vm._ssrStyle(null, {
    width: _vm.nmd_pct
  }, null) + " data-v-359e604c></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"progress-item\" style=\"margin-top: 14px;\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"progress-label-row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<span class=\"progress-name\" data-v-359e604c>MD</span> "), _vm._ssrNode("<span class=\"progress-fraction\" data-v-359e604c>", "</span>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.md_value
    }
  }), _vm._ssrNode(_vm._ssrEscape("/" + _vm._s(_vm.total_customers_display) + "\n                                "))], 2)], 2), _vm._ssrNode(" <div class=\"progress green lighten-4\" style=\"height:8px; border-radius:4px;\" data-v-359e604c><div class=\"determinate green\"" + _vm._ssrStyle(null, {
    width: _vm.md_pct
  }, null) + " data-v-359e604c></div></div>")], 2)], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"col s12 m9\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" style=\"padding-bottom: 20px;\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"energy-card-header\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div data-v-359e604c>", "</div>", [_vm._ssrNode("<p class=\"energy-card-title\" data-v-359e604c>Energy</p> <p class=\"energy-card-value\" data-v-359e604c>" + _vm._ssrEscape(_vm._s(_vm.energyTotal)) + "</p> "), _vm._ssrNode("<div class=\"loss-row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<span class=\"loss-label\" data-v-359e604c>" + _vm._ssrEscape("Feeder→DT loss: " + _vm._s(_vm.lossPctDisplay)) + "</span> "), _c('CertificationBadge', {
    attrs: {
      "status": "requires_validation"
    }
  })], 2)], 2)]), _vm._ssrNode(" <div style=\"position: relative; height:180px; overflow:visible;\" data-v-359e604c><canvas id=\"energyChart\" data-v-359e604c></canvas></div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-359e604c>", "</div>", [_vm._ssrNode("<p class=\"pie-card-title center\" data-v-359e604c>Energy Allocation per MYTO Band</p> "), _vm.energyAllocationData ? _c('ChartPie', {
    attrs: {
      "chart-type": "pie",
    ...
    staticClass: "pending-note center"
  }, [_vm._v("No band energy data returned")])], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-359e604c>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card pending-card\" data-v-359e604c>", "</div>", [_vm._ssrNode("<span class=\"vending-card-title\" data-v-359e604c>Vending &amp; Collection</span> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  }), _vm._ssrNode(" <p class=\"pending-note\" data-v-359e604c>Day-level and MTD vending/collection breakdown pending business confirmation of reporting granularity</p>")], 2)])])], 2)], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/control_center_dashboard.vue?vue&type=template&id=359e604c&scoped=true
...
/* harmony default export */ var control_center_dashboardvue_type_script_lang_js = ({
        ...
        tooltips: {
          ...
          callbacks: {
            label: function (tooltipItems) {
              return Object(controlCenterApi["b" /* formatNumber */])(tooltipItems.yLabel) + ' (raw)';
            }
          }
        },
        scales: {
  ...
  methods: {
    async getData() {
      ...
      this.error = null;
      try {
        var _pick, _pick2, _pick3, _pick4, _pick5, _pick6, _pick7;
        const [cc, overviewRes] = await Promise.all([controlCenterApi["d" /* getControlCenter */](), controlCenterApi["k" /* getOverview */]().catch(() => null)]);
        const overview = Object(controlCenterApi["o" /* pick */])(overviewRes, ['data'], {}) || {};
        this.online_feeders = Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["o" /* pick */])(cc, ['cards.total_feeders', 'feeder_summary.total_feeders', 'total_feeders'], 0));
        const kv11Raw = Object(controlCenterApi["o" /* pick */])(cc, ['cards.feeders_11kv', 'feeder_summary.feeders_11kv'], null);
        const kv33Raw = Object(controlCenterApi["o" /* pick */])(cc, ['cards.feeders_33kv', 'feeder_summary.feeders_33kv'], null);
        this.kv11 = kv11Raw != null ? Object(controlCenterApi["b" /* formatNumber */])(kv11Raw) : '—';
        this.kv33 = kv33Raw != null ? Object(controlCenterApi["b" /* formatNumber */])(kv33Raw) : '—';
        this.online_dts = Object(controlCenterApi["b" /* formatNumber */])((_pick = Object(controlCenterApi["o" /* pick */])(cc, ['cards.total_dts', 'total_dts'], null)) !== null && _pick !== void 0 ? _pick : Object(controlCenterApi["o" /* pick */])(overview, ['total_dts'], 0));
        const publicDts = (_pick2 = Object(controlCenterApi["o" /* pick */])(cc, ['cards.public_dts', 'public_dts'], null)) !== null && _pick2 !== void 0 ? _pick2 : Object(controlCenterApi["o" /* pick */])(overview, ['public_dts'], 0);
        this.public_dts = Object(controlCenterApi["b" /* formatNumber */])(publicDts);
        const privatePublic = Number((_pick3 = Object(controlCenterApi["o" /* pick */])(cc, ['cards.private_public_dts', 'private_public_dts'], null)) !== null && _pick3 !== void 0 ? _pick3 : Object(controlCenterApi["o" /* pick */])(overview, ['private_public_dts'], 0));
        const privateSingle = Number((_pick4 = Object(controlCenterApi["o" /* pick */])(cc, ['cards.private_single_dts', 'private_single_dts'], null)) !== null && _pick4 !== void 0 ? _pick4 : Object(controlCenterApi["o" /* pick */])(overview, ['private_single_dts'], 0));
        this.private_dts = privatePublic || privateSingle ? Object(controlCenterApi["b" /* formatNumber */])(privatePublic + privateSingle) : '—';
        const totalCustomers = (_pick5 = Object(controlCenterApi["o" /* pick */])(cc, ['cards.total_customers', 'total_customers'], null)) !== null && _pick5 !== void 0 ? _pick5 : Object(controlCenterApi["o" /* pick */])(overview, ['total_customers'], null);
        const nmdCustomers = (_pick6 = Object(controlCenterApi["o" /* pick */])(cc, ['cards.nmd_customers', 'nmd_customers'], null)) !== null && _pick6 !== void 0 ? _pick6 : Object(controlCenterApi["o" /* pick */])(overview, ['nmd_customers'], null);
        const mdCustomers = (_pick7 = Object(controlCenterApi["o" /* pick */])(cc, ['cards.md_customers', 'md_customers'], null)) !== null && _pick7 !== void 0 ? _pick7 : Object(controlCenterApi["o" /* pick */])(overview, ['md_customers'], null);
        this.total_customers_display = totalCustomers != null ? Object(controlCenterApi["b" /* formatNumber */])(totalCustomers) : '—';
        this.nmd_value = nmdCustomers != null ? Object(controlCenterApi["b" /* formatNumber */])(nmdCustomers) : '0';
        this.md_value = mdCustomers != null ? Object(controlCenterApi["b" /* formatNumber */])(mdCustomers) : '0';
        ...
        const lossPct = Object(controlCenterApi["o" /* pick */])(cc, ['monthly_energy.feeder_to_dt_loss_pct', 'monthly_energy.summary.feeder_to_dt_loss_pct'], null);
        this.lossPctDisplay = lossPct != null ? `${lossPct}%` : '—';

        // Energy values are raw source-derived numbers (doc §3.1) — do not label as kWh/MWh/GWh.
        const latestMonth = Object(controlCenterApi["o" /* pick */])(cc, ['monthly_energy.month_start', 'monthly_energy.summary.month_start'], null);
        const latestFeederEnergy = Object(controlCenterApi["o" /* pick */])(cc, ['monthly_energy.total_feeder_energy_raw', 'monthly_energy.summary.total_feeder_energy_raw'], null);
        this.energyTotal = latestFeederEnergy != null ? `${Object(controlCenterApi["b" /* formatNumber */])(latestFeederEnergy)} Raw` : '—';
        const bandEntries = this.normalizeBandEntries(Object(controlCenterApi["o" /* pick */])(cc, ['energy_by_band', 'monthly_energy.energy_by_band'], null));
    ...
    normalizeBandEntries(raw) {
      ...
      return entries.map(e => {
        var _ref, _ref2, _e$band, _ref3, _ref4, _e$dt_energy_raw;
        if (Array.isArray(e)) return {
          band: String(e[0]),
          value: Number(e[1]) || 0
        };
        const band = (_ref = (_ref2 = (_e$band = e.band) !== null && _e$band !== void 0 ? _e$band : e.band_code) !== null && _ref2 !== void 0 ? _ref2 : e.myto_band) !== null && _ref !== void 0 ? _ref : e.name;
        const value = (_ref3 = (_ref4 = (_e$dt_energy_raw = e.dt_energy_raw) !== null && _e$dt_energy_raw !== void 0 ? _e$dt_energy_raw : e.energy_raw) !== null && _ref4 !== void 0 ? _ref4 : e.value) !== null && _ref3 !== void 0 ? _ref3 : e.total;
        return {
          band: String(band),
    ...
    async loadEnergyTrend(latestMonth) {
      const months = Object(controlCenterApi["m" /* lastNMonths */])(latestMonth, 7);
      const responses = await Promise.all(months.map(m => controlCenterApi["i" /* getMonthlyEnergy */]({
        month: m
      }).catch(() => null)));
      this.energyData = {
        ...this.energyData,
        labels: months.map(controlCenterApi["n" /* monthLabel */]),
        datasets: [{
          ...this.energyData.datasets[0],
          data: responses.map(r => Object(controlCenterApi["o" /* pick */])(r, ['summary.total_feeder_energy_raw', 'total_feeder_energy_raw'], null))
        }]
      };
    },
    initEnergyChart() {
