...
const MeterCommunication = () => __webpack_require__.e(/* import() | components/meter-communication */ 8).then(__webpack_require__.bind(null, 54)).then(c => wrapFunctional(c.default || c));
const components_NavBar = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 8)).then(c => wrapFunctional(c.default || c));
const PreLoader = () => __webpack_require__.e(/* import() | components/pre-loader */ 9).then(__webpack_require__.bind(null, 57)).then(c => wrapFunctional(c.default || c));
