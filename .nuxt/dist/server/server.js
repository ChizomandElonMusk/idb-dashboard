...
/******/ 			var chunk = require("./" + ({"1":"components/animated-value","2":"components/certification-badge","3":"components/chart-pie","4":"components/custom-select","5":"components/d-t-details-modal","6":"components/flow-diagram-canvas","7":"components/flow-lane","8":"components/forgot","9":"components/grid-network-map","10":"components/loading-overlay","11":"components/login","12":"components/logo","13":"components/meter-communication","14":"components/pre-loader","15":"components/side-nav","16":"components/sign-up","17":"components/theme-toggle","18":"pages/availability_summary","19":"pages/control_center_dashboard","20":"pages/dt_availability","21":"pages/end_to_end_energy_dashboard","22":"pages/energy_flow_diagram","23":"pages/idb_dashboard","24":"pages/idb_events","25":"pages/index","26":"pages/myto_dashboard"}[chunkId]||chunkId) + ".js");
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/AdminNavBar.vue?vue&type=template&id=1257c28b&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "safe-area-top"
  }, [_vm._ssrNode("<link href=\"https://fonts.googleapis.com/icon?family=Material+Icons\" rel=\"stylesheet\" data-v-1257c28b>")]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/AdminNavBar.vue?vue&type=template&id=1257c28b&scoped=true
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("479bfe04", content, true, context)
};
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ":root{--bg-page:#f0f2f8;--bg-sidenav:#f8f9fd;--bg-card:#fff;--bg-card-alt:#f7f8fc;--bg-input:#fff;--bg-hover:rgba(0,0,0,.04);--bg-stripe:hsla(0,0%,95%,.5);--text-primary:#222;--text-secondary:#555;--text-muted:#888;--text-faint:#aaa;--border-color:#eee;--border-strong:#ddd;--divider:#f0f0f0;--shadow-color:rgba(0,0,0,.08);--meter-track:#eee;--meter-needle:#333;--csstools-color-scheme--dark: ;color-scheme:light}[data-theme=dark]{--bg-page:#12121a;--bg-sidenav:#17171f;--bg-card:#1e1e29;--bg-card-alt:#23232f;--bg-input:#23232f;--bg-hover:hsla(0,0%,100%,.06);--bg-stripe:hsla(0,0%,100%,.04);--text-primary:#ececf2;--text-secondary:#b7b7c4;--text-muted:#8b8b99;--text-faint:#6f6f7d;--border-color:#2c2c3a;--border-strong:#383846;--divider:#2a2a37;--shadow-color:rgba(0,0,0,.4);--meter-track:#33333f;--meter-needle:#ececf2;--csstools-color-scheme--dark:initial;color-scheme:dark}[data-theme=dark] body{background-color:#f0f2f8;background-color:var(--bg-page);color:#222;color:var(--text-primary)}[data-theme=dark] .card,[data-theme=dark] .card-panel,[data-theme=dark] .collapsible,[data-theme=dark] .dropdown-content,[data-theme=dark] .modal{background-color:#fff;background-color:var(--bg-card);color:#222;color:var(--text-primary)}[data-theme=dark] .sidenav{background-color:#f8f9fd;background-color:var(--bg-sidenav)}[data-theme=dark] .sidenav li>a{color:#555;color:var(--text-secondary)}[data-theme=dark] table.striped>tbody>tr:nth-child(odd){background-color:hsla(0,0%,95%,.5);background-color:var(--bg-stripe)}[data-theme=dark] table.highlight>tbody>tr:hover{background-color:rgba(0,0,0,.04);background-color:var(--bg-hover)}[data-theme=dark] td,[data-theme=dark] th{color:#222;color:var(--text-primary)}[data-theme=dark] .grey-text{color:#9a9aa8!important}[data-theme=dark] .grey-text.text-darken-1,[data-theme=dark] .grey-text.text-darken-2,[data-theme=dark] .grey-text.text-darken-3,[data-theme=dark] .grey-text.text-darken-4{color:#555!important;color:var(--text-secondary)!important}[data-theme=dark] .black-text{color:#222!important;color:var(--text-primary)!important}[data-theme=dark] input[type=email]:not(.browser-default),[data-theme=dark] input[type=password]:not(.browser-default),[data-theme=dark] input[type=search]:not(.browser-default),[data-theme=dark] input[type=text]:not(.browser-default),[data-theme=dark] textarea.materialize-textarea{border-bottom:1px solid #ddd;border-bottom:1px solid var(--border-strong);color:#222;color:var(--text-primary)}[data-theme=dark] .input-field>label{color:#888;color:var(--text-muted)}[data-theme=dark] ::-moz-placeholder{color:#aaa;color:var(--text-faint)}[data-theme=dark] ::placeholder{color:#aaa;color:var(--text-faint)}[data-theme=dark] .divider,[data-theme=dark] hr{background-color:#eee;background-color:var(--border-color);border-color:#eee;border-color:var(--border-color)}[data-theme=dark] ::-webkit-scrollbar{height:10px;width:10px}[data-theme=dark] ::-webkit-scrollbar-track{background:#f0f2f8;background:var(--bg-page)}[data-theme=dark] ::-webkit-scrollbar-thumb{background:#ddd;background:var(--border-strong);border-radius:6px}.theme-toggle-btn{align-items:center;background:#f7f8fc;background:var(--bg-card-alt);border:1px solid #eee;border:1px solid var(--border-color);border-radius:8px;color:#555;color:var(--text-secondary);cursor:pointer;display:flex;font-size:11px;font-weight:600;gap:6px;justify-content:center;letter-spacing:.3px;margin:6px 0 10px;padding:8px 0;transition:background-color .2s ease,color .2s ease,border-color .2s ease;width:100%}.theme-toggle-btn:focus,.theme-toggle-btn:hover{background:rgba(0,0,0,.04);background:var(--bg-hover)}.theme-toggle-btn .material-icons{font-size:16px!important}.login-theme-toggle:focus{background:rgba(0,0,0,.04);background:var(--bg-hover);outline:none}.mini-chart-card canvas{display:block}.mini-chart-card{overflow:visible}.safe-area-bottom{padding-bottom:50px}.safe-area-top{padding-top:35px}.flexcontainerSearch,.flexitem-datepicker{align-items:center;display:flex}.flexitem-datepicker{flex-grow:1}.input-field>label{color:gray;cursor:text;font-size:1rem;left:0;position:absolute;text-align:left;text-align:initial;top:0;transform:translateY(12px);transform-origin:0 100%;transition:transform .2s ease-out,color .2s ease-out}.input-field input:focus+label{color:gray!important}.row .input-field input:focus{border-bottom:1px solid gray!important;box-shadow:0 1px 0 0 gray!important}.full-width{height:100vh!important;margin:0}.row{margin-bottom:0!important}.overlay-red{background-color:#f44336;cursor:pointer;z-index:2}.customButtonColor{background-color:#12121a}::-moz-placeholder{color:gray}::placeholder{color:gray}nav .brand-logo,nav ul a{color:#444}p{line-height:2rem}.sidenav-trigger{color:#26a69a}.parallax-container{color:hsla(0,0%,100%,.9);height:auto;line-height:0;min-height:380px}.parallax-container .section{width:100%}@media only screen and (max-width:992px){.parallax-container .section{position:absolute;top:40%}#index-banner .section{top:10%}}@media only screen and (max-width:600px){#index-banner .section{top:0}}.icon-block{padding:0 15px}.icon-block .material-icons{font-size:inherit}footer.page-footer{margin:0}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminNavBar_vue_vue_type_style_index_0_id_1257c28b_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminNavBar_vue_vue_type_style_index_0_id_1257c28b_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminNavBar_vue_vue_type_style_index_0_id_1257c28b_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminNavBar_vue_vue_type_style_index_0_id_1257c28b_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminNavBar_vue_vue_type_style_index_0_id_1257c28b_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, "[data-v-1257c28b]::-moz-placeholder{color:red}[data-v-1257c28b]::placeholder{color:red}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
__webpack_require__.d(components_namespaceObject, "AnimatedValue", function() { return AnimatedValue; });
__webpack_require__.d(components_namespaceObject, "CertificationBadge", function() { return CertificationBadge; });
__webpack_require__.d(components_namespaceObject, "ChartPie", function() { return ChartPie; });
__webpack_require__.d(components_namespaceObject, "CustomSelect", function() { return CustomSelect; });
__webpack_require__.d(components_namespaceObject, "DTDetailsModal", function() { return DTDetailsModal; });
__webpack_require__.d(components_namespaceObject, "FlowDiagramCanvas", function() { return FlowDiagramCanvas; });
__webpack_require__.d(components_namespaceObject, "FlowLane", function() { return FlowLane; });
__webpack_require__.d(components_namespaceObject, "Forgot", function() { return Forgot; });
__webpack_require__.d(components_namespaceObject, "GridNetworkMap", function() { return GridNetworkMap; });
...
__webpack_require__.d(components_namespaceObject, "MeterCommunication", function() { return MeterCommunication; });
...
__webpack_require__.d(components_namespaceObject, "ThemeToggle", function() { return ThemeToggle; });
...
async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      env: {
        "CONTROL_CENTER_API_BASE_URL": "http://192.168.80.108:8090/api/v1"
      }
    };
    // Only set once
...
const _084026bd = () => interopDefault(__webpack_require__.e(/* import() | pages/availability_summary */ 18).then(__webpack_require__.bind(null, 151)));
const _912cc572 = () => interopDefault(__webpack_require__.e(/* import() | pages/control_center_dashboard */ 19).then(__webpack_require__.bind(null, 152)));
const _e62b2802 = () => interopDefault(__webpack_require__.e(/* import() | pages/dt_availability */ 20).then(__webpack_require__.bind(null, 153)));
const _511c64b6 = () => interopDefault(__webpack_require__.e(/* import() | pages/end_to_end_energy_dashboard */ 21).then(__webpack_require__.bind(null, 154)));
const _d6ea8f24 = () => interopDefault(__webpack_require__.e(/* import() | pages/energy_flow_diagram */ 22).then(__webpack_require__.bind(null, 155)));
const _61667891 = () => interopDefault(__webpack_require__.e(/* import() | pages/idb_dashboard */ 23).then(__webpack_require__.bind(null, 156)));
const _20bd9bec = () => interopDefault(__webpack_require__.e(/* import() | pages/idb_events */ 24).then(__webpack_require__.bind(null, 157)));
const _a9b92e92 = () => interopDefault(__webpack_require__.e(/* import() | pages/myto_dashboard */ 26).then(__webpack_require__.bind(null, 158)));
const _16c57c67 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 25).then(__webpack_require__.bind(null, 150)));
const emptyFn = () => {};
...
const routerOptions = {
  ...
  routes: [{
    ...
    path: "/end_to_end_energy_dashboard",
    component: _511c64b6,
    name: "end_to_end_energy_dashboard"
  }, {
    path: "/energy_flow_diagram",
    component: _d6ea8f24,
    name: "energy_flow_diagram"
  }, {
    path: "/idb_dashboard",
    component: _61667891,
    name: "idb_dashboard"
...
var leaflet = __webpack_require__(30);
...
const AnimatedValue = () => __webpack_require__.e(/* import() | components/animated-value */ 1).then(__webpack_require__.bind(null, 82)).then(c => wrapFunctional(c.default || c));
const CertificationBadge = () => __webpack_require__.e(/* import() | components/certification-badge */ 2).then(__webpack_require__.bind(null, 159)).then(c => wrapFunctional(c.default || c));
const ChartPie = () => __webpack_require__.e(/* import() | components/chart-pie */ 3).then(__webpack_require__.bind(null, 90)).then(c => wrapFunctional(c.default || c));
const CustomSelect = () => __webpack_require__.e(/* import() | components/custom-select */ 4).then(__webpack_require__.bind(null, 160)).then(c => wrapFunctional(c.default || c));
const DTDetailsModal = () => __webpack_require__.e(/* import() | components/d-t-details-modal */ 5).then(__webpack_require__.bind(null, 113)).then(c => wrapFunctional(c.default || c));
const FlowDiagramCanvas = () => __webpack_require__.e(/* import() | components/flow-diagram-canvas */ 6).then(__webpack_require__.bind(null, 114)).then(c => wrapFunctional(c.default || c));
const FlowLane = () => __webpack_require__.e(/* import() | components/flow-lane */ 7).then(__webpack_require__.bind(null, 103)).then(c => wrapFunctional(c.default || c));
const Forgot = () => __webpack_require__.e(/* import() | components/forgot */ 8).then(__webpack_require__.bind(null, 161)).then(c => wrapFunctional(c.default || c));
const GridNetworkMap = () => __webpack_require__.e(/* import() | components/grid-network-map */ 9).then(__webpack_require__.bind(null, 112)).then(c => wrapFunctional(c.default || c));
const LoadingOverlay = () => __webpack_require__.e(/* import() | components/loading-overlay */ 10).then(__webpack_require__.bind(null, 80)).then(c => wrapFunctional(c.default || c));
const Login = () => __webpack_require__.e(/* import() | components/login */ 11).then(__webpack_require__.bind(null, 162)).then(c => wrapFunctional(c.default || c));
const Logo = () => __webpack_require__.e(/* import() | components/logo */ 12).then(__webpack_require__.bind(null, 163)).then(c => wrapFunctional(c.default || c));
const MeterCommunication = () => __webpack_require__.e(/* import() | components/meter-communication */ 13).then(__webpack_require__.bind(null, 96)).then(c => wrapFunctional(c.default || c));
const components_NavBar = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 8)).then(c => wrapFunctional(c.default || c));
const PreLoader = () => __webpack_require__.e(/* import() | components/pre-loader */ 14).then(__webpack_require__.bind(null, 115)).then(c => wrapFunctional(c.default || c));
const SignUp = () => __webpack_require__.e(/* import() | components/sign-up */ 16).then(__webpack_require__.bind(null, 164)).then(c => wrapFunctional(c.default || c));
const ThemeToggle = () => __webpack_require__.e(/* import() | components/theme-toggle */ 17).then(__webpack_require__.bind(null, 76)).then(c => wrapFunctional(c.default || c));
const SideNav = () => __webpack_require__.e(/* import() | components/side-nav */ 15).then(__webpack_require__.bind(null, 78)).then(c => wrapFunctional(c.default || c));
...
const state = external_vue_default.a.observable({
...
external_vue_default.a.prototype.$theme = theme;
...
/* harmony default export */ var plugins_theme = (({
  app
}) => {
  if (true) return;
...
/* Plugins */
 ...
 // Source: ../plugins/theme.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (false) {}
  if (typeof plugins_theme === 'function') {
    await plugins_theme(app.context, inject);
  }
