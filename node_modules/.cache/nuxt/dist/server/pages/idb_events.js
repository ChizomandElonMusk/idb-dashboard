...
/* harmony default export */ var idb_eventsvue_type_script_lang_js = ({
  ...
  methods: {
    async getData() {
      try {
        this.eventsResponse = await controlCenterApi["i" /* getIdbEvents */]();
      } catch (err) {
...
installComponents(component, {SideNav: __webpack_require__(41).default,CertificationBadge: __webpack_require__(52).default})
