  ...
  methods: {
    async getData() {
      ...
      try {
        ...
        const [cc, overviewRes] = await Promise.all([controlCenterApi["d" /* getControlCenter */](), controlCenterApi["m" /* getOverview */]().catch(() => null)]);
        const overview = Object(controlCenterApi["r" /* pick */])(overviewRes, ['data'], {}) || {};
        this.online_feeders = Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["r" /* pick */])(cc, ['cards.total_feeders', 'feeder_summary.total_feeders', 'total_feeders'], 0));
        const kv11Raw = Object(controlCenterApi["r" /* pick */])(cc, ['cards.feeders_11kv', 'feeder_summary.feeders_11kv'], null);
        const kv33Raw = Object(controlCenterApi["r" /* pick */])(cc, ['cards.feeders_33kv', 'feeder_summary.feeders_33kv'], null);
        ...
        this.online_dts = Object(controlCenterApi["b" /* formatNumber */])((_pick = Object(controlCenterApi["r" /* pick */])(cc, ['cards.total_dts', 'total_dts'], null)) !== null && _pick !== void 0 ? _pick : Object(controlCenterApi["r" /* pick */])(overview, ['total_dts'], 0));
        const publicDts = (_pick2 = Object(controlCenterApi["r" /* pick */])(cc, ['cards.public_dts', 'public_dts'], null)) !== null && _pick2 !== void 0 ? _pick2 : Object(controlCenterApi["r" /* pick */])(overview, ['public_dts'], 0);
        this.public_dts = Object(controlCenterApi["b" /* formatNumber */])(publicDts);
        const privatePublic = Number((_pick3 = Object(controlCenterApi["r" /* pick */])(cc, ['cards.private_public_dts', 'private_public_dts'], null)) !== null && _pick3 !== void 0 ? _pick3 : Object(controlCenterApi["r" /* pick */])(overview, ['private_public_dts'], 0));
        const privateSingle = Number((_pick4 = Object(controlCenterApi["r" /* pick */])(cc, ['cards.private_single_dts', 'private_single_dts'], null)) !== null && _pick4 !== void 0 ? _pick4 : Object(controlCenterApi["r" /* pick */])(overview, ['private_single_dts'], 0));
        this.private_dts = privatePublic || privateSingle ? Object(controlCenterApi["b" /* formatNumber */])(privatePublic + privateSingle) : '—';
        const totalCustomers = (_pick5 = Object(controlCenterApi["r" /* pick */])(cc, ['cards.total_customers', 'total_customers'], null)) !== null && _pick5 !== void 0 ? _pick5 : Object(controlCenterApi["r" /* pick */])(overview, ['total_customers'], null);
        const nmdCustomers = (_pick6 = Object(controlCenterApi["r" /* pick */])(cc, ['cards.nmd_customers', 'nmd_customers'], null)) !== null && _pick6 !== void 0 ? _pick6 : Object(controlCenterApi["r" /* pick */])(overview, ['nmd_customers'], null);
        const mdCustomers = (_pick7 = Object(controlCenterApi["r" /* pick */])(cc, ['cards.md_customers', 'md_customers'], null)) !== null && _pick7 !== void 0 ? _pick7 : Object(controlCenterApi["r" /* pick */])(overview, ['md_customers'], null);
        ...
        const lossPct = Object(controlCenterApi["r" /* pick */])(cc, ['monthly_energy.feeder_to_dt_loss_pct', 'monthly_energy.summary.feeder_to_dt_loss_pct'], null);
        this.lossPctDisplay = lossPct != null ? `${lossPct}%` : '—';

        // Energy values are raw source-derived numbers (doc §3.1) — do not label as kWh/MWh/GWh.
        const latestMonth = Object(controlCenterApi["r" /* pick */])(cc, ['monthly_energy.month_start', 'monthly_energy.summary.month_start'], null);
        const latestFeederEnergy = Object(controlCenterApi["r" /* pick */])(cc, ['monthly_energy.total_feeder_energy_raw', 'monthly_energy.summary.total_feeder_energy_raw'], null);
        this.energyTotal = latestFeederEnergy != null ? `${Object(controlCenterApi["b" /* formatNumber */])(latestFeederEnergy)} Raw` : '—';
        const bandEntries = this.normalizeBandEntries(Object(controlCenterApi["r" /* pick */])(cc, ['energy_by_band', 'monthly_energy.energy_by_band'], null));
    ...
    async loadEnergyTrend(latestMonth) {
      const months = Object(controlCenterApi["p" /* lastNMonths */])(latestMonth, 7);
      const responses = await Promise.all(months.map(m => controlCenterApi["j" /* getMonthlyEnergy */]({
        month: m
      }).catch(() => null)));
      this.energyData = {
        ...this.energyData,
        labels: months.map(controlCenterApi["q" /* monthLabel */]),
        datasets: [{
          ...this.energyData.datasets[0],
          data: responses.map(r => Object(controlCenterApi["r" /* pick */])(r, ['summary.total_feeder_energy_raw', 'total_feeder_energy_raw'], null))
        }]
      };
    },
    initEnergyChart() {
