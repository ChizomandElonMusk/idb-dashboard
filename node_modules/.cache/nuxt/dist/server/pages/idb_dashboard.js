...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("a2d61300", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_38c77273_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_38c77273_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_38c77273_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_38c77273_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_idb_dashboard_vue_vue_type_style_index_0_id_38c77273_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-38c77273]{background-color:var(--bg-page);min-height:100vh}.sidenav[data-v-38c77273]{border-right:1px solid var(--border-color);width:260px}.main-content[data-v-38c77273]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-title[data-v-38c77273]{color:var(--text-primary);font-weight:600;margin:0}.state-panel[data-v-38c77273]{align-items:center;display:flex;flex-direction:column;gap:12px;justify-content:center;padding:60px 20px}.state-message[data-v-38c77273]{color:var(--text-secondary);text-align:center}.retry-btn[data-v-38c77273]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary)}.pending-card[data-v-38c77273]{text-align:center}.pending-note[data-v-38c77273]{color:var(--text-muted);font-size:12px;margin:8px 0 0}.stats-card[data-v-38c77273]{border-radius:12px;position:relative}.icon-circle[data-v-38c77273]{align-items:center;border-radius:50%;display:flex;height:50px;justify-content:center;margin-right:15px;width:50px}.stats-text .value[data-v-38c77273]{display:inline-block;font-size:24px;font-weight:700}.counting[data-v-38c77273]{animation:pop-38c77273 1s ease-out}@keyframes pop-38c77273{0%{transform:scale(1)}50%{transform:scale(1.4)}to{transform:scale(1)}}.stats-text p[data-v-38c77273]{font-size:12px;margin:0}.mini-chart-card[data-v-38c77273]{border-radius:12px;margin-bottom:10px}.tiny-text[data-v-38c77273]{font-size:11px;margin-bottom:5px}.border-right[data-v-38c77273]{border-right:1px solid var(--border-color)}.circle[data-v-38c77273]{border-radius:50%;display:inline-block;vertical-align:middle}.circle.orange[data-v-38c77273]{background-color:orange}.circle.green[data-v-38c77273]{background-color:green}.tabs[data-v-38c77273]{background:transparent;border-bottom:1px solid var(--border-strong);margin-bottom:8px}.tabs .tab a[data-v-38c77273]{align-items:center;color:var(--text-muted);display:flex;font-size:14px;gap:6px;text-transform:none}.tabs .tab a .tab-icon[data-v-38c77273]{font-size:16px!important}.tabs .tab a.active.dashboard-tab[data-v-38c77273]{border-bottom:2px solid #c0392b;color:#c0392b}.tabs .tab a.active.customer-tab[data-v-38c77273],.tabs .tab a.active.feeder-tab[data-v-38c77273]{border-bottom:2px solid #e8941a;color:#e8941a}.tabs .indicator[data-v-38c77273]{display:none}.filter-row-right[data-v-38c77273]{display:flex;gap:10px;justify-content:flex-end;margin-bottom:16px}.filter-pill[data-v-38c77273]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;gap:6px;min-width:110px;padding:8px 12px}.filter-label[data-v-38c77273]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-38c77273]{color:var(--text-muted);font-size:20px!important}.idb-vending-value[data-v-38c77273]{color:var(--text-primary);font-size:20px;font-weight:700;margin:6px 0}.chart-legend-list[data-v-38c77273]{margin-top:10px}.cleg-item[data-v-38c77273]{align-items:center;display:flex;gap:6px;margin-bottom:5px}.cleg-dot[data-v-38c77273]{border-radius:50%;flex-shrink:0;height:10px;width:10px}.cleg-label[data-v-38c77273]{color:var(--text-secondary);flex:1;font-size:12px}.cleg-val[data-v-38c77273]{color:var(--text-primary);font-size:12px;font-weight:700}table.rounded-header thead.orange[data-v-38c77273]{border-radius:20px;display:table-header-group;overflow:hidden}table.rounded-header[data-v-38c77273]{border-collapse:separate;border-spacing:0}table.rounded-header thead.orange th[data-v-38c77273]{background-color:orange;color:#fff;padding:10px 15px}table.rounded-header thead.orange th[data-v-38c77273]:first-child{border-bottom-left-radius:10px;border-top-left-radius:10px}table.rounded-header thead.orange th[data-v-38c77273]:last-child{border-bottom-right-radius:10px;border-top-right-radius:10px}table.rounded-header thead.orange th[data-v-38c77273]:not(:first-child):not(:last-child){border-radius:0}.table-wrapper[data-v-38c77273]{overflow-x:auto;-webkit-overflow-scrolling:touch}.table-wrapper table[data-v-38c77273]{width:-moz-max-content;width:max-content}@media only screen and (max-width:992px){.main-content[data-v-38c77273]{padding-left:20px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/idb_dashboard.vue?vue&type=template&id=38c77273&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-38c77273>", "</main>", [_vm._ssrNode("<div class=\"row header-row\" style=\"margin-bottom: 0;\" data-v-38c77273><div class=\"col s12\" data-v-38c77273><h5 class=\"avail-title\" data-v-38c77273>IDB Dashboard</h5> <ul class=\"tabs\" data-v-38c77273><li class=\"tab\" data-v-38c77273><a href=\"#dashboard\" class=\"active tab-link dashboard-tab\" data-v-38c77273><i class=\"material-icons tiny tab-icon\" data-v-38c77273>speed</i> Dashboard\n                        </a></li> <li class=\"tab\" data-v-38c77273><a href=\"#feeder-loss\" class=\"tab-link feeder-tab\" data-v-38c77273><i class=\"material-icons tiny tab-icon\" data-v-38c77273>apps</i> High-Impact Feeders\n                        </a></li> <li class=\"tab\" data-v-38c77273><a href=\"#customer-loss\" class=\"tab-link customer-tab\" data-v-38c77273><i class=\"material-icons tiny tab-icon\" data-v-38c77273>apps</i> Customer to DT loss Table\n                        </a></li></ul></div></div> <div class=\"filter-row-right\" data-v-38c77273><div class=\"filter-pill\" data-v-38c77273><span class=\"filter-label\" data-v-38c77273>All feeders</span> <i class=\"material-icons filter-arrow\" data-v-38c77273>arrow_drop_down</i></div> <div class=\"filter-pill\" data-v-38c77273><span class=\"filter-label\" data-v-38c77273>Date</span> <i class=\"material-icons\" style=\"font-size:18px; color:#888;\" data-v-38c77273>calendar_today</i></div></div> "), _vm.loading ? _vm._ssrNode("<div class=\"state-panel\" data-v-38c77273>", "</div>", [_c('PreLoader')], 1) : _vm.error ? _vm._ssrNode("<div class=\"state-panel\" data-v-38c77273><p class=\"state-message\" data-v-38c77273>" + _vm._ssrEscape("Could not load IDB dashboard data: " + _vm._s(_vm.error)) + "</p> <button class=\"btn-flat retry-btn\" data-v-38c77273>Retry</button></div>") : [_vm._ssrNode("<div id=\"dashboard\" class=\"row\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel stats-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"valign-wrapper\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"icon-circle orange\" data-v-38c77273><i class=\"material-icons white-text\" data-v-38c77273>bolt</i></div> "), _vm._ssrNode("<div class=\"stats-text\" data-v-38c77273>", "</div>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.energy_total
    }
  }), _vm._ssrNode(" <p class=\"grey-text\" data-v-38c77273>Total Feeder Energy Raw</p>")], 2)], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel stats-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"valign-wrapper\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"icon-circle red darken-2\" data-v-38c77273><i class=\"material-icons white-text\" data-v-38c77273>router</i></div> "), _vm._ssrNode("<div class=\"stats-text\" data-v-38c77273>", "</div>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.total_feeders
    }
  }), _vm._ssrNode(" <p class=\"grey-text\" data-v-38c77273>Total Feeders</p>")], 2)], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel stats-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"valign-wrapper\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"icon-circle green\" data-v-38c77273><i class=\"material-icons white-text\" data-v-38c77273>battery_charging_full</i></div> "), _vm._ssrNode("<div class=\"stats-text\" data-v-38c77273>", "</div>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.total_flagged
    }
  }), _vm._ssrNode(" <p class=\"grey-text\" data-v-38c77273>High-impact feeders (P99 flag)</p>")], 2)], 2)])])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-38c77273>Feeder - to - DT Loss</p> "), _vm._ssrNode("<h5 data-v-38c77273>", "</h5>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.feeder_loss
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<p class=\"tiny-text grey-text\" data-v-38c77273>", "</p>", [_vm._ssrNode("Loss (%) "), _vm._ssrNode("<span class=\"right\" data-v-38c77273>", "</span>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.feeder_loss_pct
    }
  })], 1)], 2), _vm._ssrNode(" <div class=\"progress red lighten-4\" data-v-38c77273><div class=\"determinate red\"" + _vm._ssrStyle(null, {
    width: _vm.feeder_loss_pct
  }, null) + " data-v-38c77273></div></div> "), _c('CertificationBadge', {
    attrs: {
      "status": "requires_validation"
    }
  })], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"card-panel mini-chart-card pending-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-38c77273>Billing Efficiency</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  })], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card pending-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-38c77273>Customer - to - DT Loss</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  }), _vm._ssrNode(" <p class=\"pending-note\" data-v-38c77273>Requires customer consumption source</p>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"card-panel mini-chart-card pending-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2\" data-v-38c77273>ATC &amp; C</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  })], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m4\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel dt-summary-card mini-chart-card\" style=\"padding-bottom: 82px\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"row center-align\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-38c77273>", "</div>", [_vm._ssrNode("<h3 data-v-38c77273>", "</h3>", [_vm._ssrNode("<div class=\"icon-circle red darken-2\" style=\"margin: 0 auto;\" data-v-38c77273><i class=\"material-icons white-text\" data-v-38c77273>router</i></div> "), _c('AnimatedValue', {
    attrs: {
      "value": _vm.total_dts
    }
  })], 2), _vm._ssrNode(" <p class=\"grey-text\" data-v-38c77273>Total DTs</p> <div class=\"divider\" data-v-38c77273></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6 border-right\" data-v-38c77273>", "</div>", [_vm._ssrNode("<h5 data-v-38c77273>", "</h5>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.public_dts
    }
  })], 1), _vm._ssrNode(" <p class=\"grey-text\" data-v-38c77273>Public</p>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6\" data-v-38c77273>", "</div>", [_vm._ssrNode("<h5 data-v-38c77273>", "</h5>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.private_dts
    }
  })], 1), _vm._ssrNode(" <p class=\"grey-text\" data-v-38c77273>Private</p>")], 2)], 2)])])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"col s12 m3\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2 center\" data-v-38c77273>Total Customers</p> "), _vm.doughnutData ? _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
  ...
  }) : _vm._e(), _vm._ssrNode(" <div class=\"chart-legend-list\" data-v-38c77273>" + _vm._ssrList(_vm.customerLegend, function (item) {
    return "<div class=\"cleg-item\" data-v-38c77273><span class=\"cleg-dot\"" + _vm._ssrStyle(null, {
      backgroundColor: item.color
    }, null) + " data-v-38c77273></span> <span class=\"cleg-label\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(item.label)) + "</span> <span class=\"cleg-val\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(item.value)) + "</span></div>";
  }) + "</div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2 center\" data-v-38c77273>IDB Prepaid Vending</p> "), _vm._ssrNode("<p class=\"idb-vending-value center\" data-v-38c77273>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.idb_prepaid_total_amount
    }
  })], 1), _vm._ssrNode(" <div class=\"chart-legend-list\" data-v-38c77273><div class=\"cleg-item\" data-v-38c77273><span class=\"cleg-label\" data-v-38c77273>Accounts</span> <span class=\"cleg-val\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(_vm.idb_prepaid_accounts)) + "</span></div> <div class=\"cleg-item\" data-v-38c77273><span class=\"cleg-label\" data-v-38c77273>Meters</span> <span class=\"cleg-val\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(_vm.idb_prepaid_meters)) + "</span></div> <div class=\"cleg-item\" data-v-38c77273><span class=\"cleg-label\" data-v-38c77273>Total kWh</span> <span class=\"cleg-val\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(_vm.idb_prepaid_total_kwh)) + "</span></div></div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card pending-card\" style=\"display:flex; flex-direction:column; justify-content:center;\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2 center\" data-v-38c77273>Energy by Demand Type</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  }), _vm._ssrNode(" <p class=\"pending-note center\" data-v-38c77273>MD/NMD energy split not yet available from this endpoint</p>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m3\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-chart-card pending-card\" style=\"display:flex; flex-direction:column; align-items:center; justify-content:center;\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text text-darken-2 center\" data-v-38c77273>Meter Communication</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  })], 2)])], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"feeder-loss\" class=\"row\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-38c77273>", "</div>", [_vm._ssrNode("<p class=\"grey-text\" style=\"margin: 0 0 10px 4px;\" data-v-38c77273>", "</p>", [_vm._ssrNode("\n                    High-impact feeder rows dominate total feeder energy — treat contribution % as\n                    "), _c('CertificationBadge', {
    attrs: {
      "status": "requires_validation"
    }
  })], 2), _vm._ssrNode(" <div class=\"table-wrapper\" data-v-38c77273><table class=\"rounded-header striped highlight\" data-v-38c77273><thead class=\"orange white-text\" style=\"border: 1px solid #ff9800;\" data-v-38c77273><tr data-v-38c77273><th data-v-38c77273>Feeder</th> <th data-v-38c77273>Feeder Energy Raw</th> <th data-v-38c77273>Contribution %</th> <th data-v-38c77273>P99 Flag</th></tr></thead> <tbody data-v-38c77273>" + _vm._ssrList(_vm.data_quality_rows, function (value) {
    return "<tr data-v-38c77273><td style=\"font-size: 12px; font-weight: 600;\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(value.feeder)) + "</td> <td style=\"font-size: 12px;\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(value.energy)) + "</td> <td style=\"font-size: 12px;\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(value.contribution_pct)) + "</td> <td style=\"font-size: 12px;\" data-v-38c77273>" + _vm._ssrEscape(_vm._s(value.p99_flag ? 'Yes' : 'No')) + "</td></tr>";
  }) + " " + (!_vm.data_quality_rows.length ? "<tr data-v-38c77273><td colspan=\"4\" class=\"center-align pending-note\" data-v-38c77273>No high-impact feeder rows returned</td></tr>" : "<!---->") + "</tbody></table></div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"customer-loss\" class=\"row\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-38c77273>", "</div>", [_vm._ssrNode("<div class=\"card-panel pending-card\" data-v-38c77273>", "</div>", [_c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  }), _vm._ssrNode(" <p class=\"pending-note\" data-v-38c77273>Customer-to-DT loss data pending customer consumption source onboarding</p>")], 2)])])]], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/idb_dashboard.vue?vue&type=template&id=38c77273&scoped=true
  ...
  methods: {
    async getData() {
      ...
      try {
        ...
        this.idb_prepaid_accounts = Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["o" /* pick */])(idb, ['cards.idb_prepaid_accounts'], 0));
        this.idb_prepaid_meters = Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["o" /* pick */])(idb, ['cards.idb_prepaid_meters'], 0));
        this.idb_prepaid_total_amount = `₦${Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["o" /* pick */])(idb, ['cards.idb_prepaid_total_amount'], 0))}`;
        this.idb_prepaid_total_kwh = Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["o" /* pick */])(idb, ['cards.idb_prepaid_total_kwh'], 0));
