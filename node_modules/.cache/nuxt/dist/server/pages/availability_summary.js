  ...
  methods: {
    async getData() {
      ...
      try {
        ...
        const summary = Object(controlCenterApi["r" /* pick */])(summaryRes, ['data'], summaryRes);
        const totalFeederMeters = Number(Object(controlCenterApi["r" /* pick */])(summary, ['total_feeder_meters'], 0));
        const feederMet20 = Number(Object(controlCenterApi["r" /* pick */])(summary, ['feeder_met_20_hours'], 0));
        this.feeders_total = Object(controlCenterApi["b" /* formatNumber */])(totalFeederMeters);
        this.feeder_date = Object(controlCenterApi["r" /* pick */])(summary, ['feeder_availability_date'], '—');
        ...
        const totalDtMeters = Number(Object(controlCenterApi["r" /* pick */])(summary, ['total_dt_meters'], 0));
        const dtMet20 = Number(Object(controlCenterApi["r" /* pick */])(summary, ['dt_met_20_hours'], 0));
        this.total_dts = Object(controlCenterApi["b" /* formatNumber */])(totalDtMeters);
        this.dt_date = Object(controlCenterApi["r" /* pick */])(summary, ['dt_availability_date'], '—');
        this.dtsAvailData = {
          labels: ['Met 20h+', 'Not Met'],
          datasets: [{
        ...
        const dtZero = Number(Object(controlCenterApi["r" /* pick */])(summary, ['dt_zero_hours'], 0));
        const dtBelow12 = Number(Object(controlCenterApi["r" /* pick */])(summary, ['dt_below_12_hours'], 0));
        const dt12to20 = Number(Object(controlCenterApi["r" /* pick */])(summary, ['dt_12_to_20_hours'], 0));
        const dtFull24 = Number(Object(controlCenterApi["r" /* pick */])(summary, ['dt_full_24_hours'], 0));
...
installComponents(component, {SideNav: __webpack_require__(41).default,PreLoader: __webpack_require__(49).default,ChartPie: __webpack_require__(57).default,CertificationBadge: __webpack_require__(52).default})
