...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("1df14f87", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_bb1009e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(62);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_bb1009e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_bb1009e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_bb1009e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dt_availability_vue_vue_type_style_index_0_id_bb1009e4_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-bb1009e4]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-bb1009e4]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-title[data-v-bb1009e4]{color:var(--text-primary);font-weight:600;margin:0}.state-panel[data-v-bb1009e4]{align-items:center;display:flex;flex-direction:column;gap:12px;justify-content:center;padding:60px 20px}.state-message[data-v-bb1009e4]{color:var(--text-secondary);text-align:center}.retry-btn[data-v-bb1009e4]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary)}.pending-card[data-v-bb1009e4]{justify-content:center!important;text-align:center}.pending-note[data-v-bb1009e4]{color:var(--text-muted);font-size:12px;margin:8px 0 0}.tabs[data-v-bb1009e4]{background:transparent;border-bottom:1px solid var(--border-strong);margin-bottom:20px}.tabs .tab a[data-v-bb1009e4]{align-items:center;color:var(--text-muted);display:flex;font-size:14px;gap:6px;text-transform:none}.tabs .tab a .tab-icon[data-v-bb1009e4]{font-size:16px!important}.tabs .tab a.active.dashboard-tab[data-v-bb1009e4]{border-bottom:2px solid #c0392b;color:#c0392b}.tabs .tab a.active.table-tab[data-v-bb1009e4]{border-bottom:2px solid #e8941a;color:#e8941a}.tabs .indicator[data-v-bb1009e4]{display:none}.filter-row[data-v-bb1009e4]{margin-bottom:10px}.filter-pill[data-v-bb1009e4]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;justify-content:space-between;padding:8px 12px}.filter-label[data-v-bb1009e4]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-bb1009e4]{color:var(--text-muted);font-size:20px!important}.metric-card[data-v-bb1009e4]{border-radius:12px;display:flex;flex-direction:column;justify-content:space-between;margin-bottom:12px;min-height:90px;padding:16px}.metric-label[data-v-bb1009e4]{color:var(--text-muted);font-size:11px;line-height:1.4;margin:0 0 8px}.metric-value[data-v-bb1009e4]{font-size:22px;font-weight:700;margin:0}.green-value[data-v-bb1009e4]{color:#27ae60}.trend-card[data-v-bb1009e4]{border-radius:12px;padding:20px}.trend-header[data-v-bb1009e4]{align-items:center;display:flex;justify-content:space-between;margin-bottom:16px}.trend-title[data-v-bb1009e4]{color:var(--text-primary);font-size:15px;font-weight:600}.trend-legend[data-v-bb1009e4]{border-top:1px solid var(--divider);display:flex;gap:24px;margin-top:12px;padding-top:12px}.legend-item[data-v-bb1009e4]{align-items:center;color:var(--text-secondary);display:flex;font-size:13px;gap:8px}.legend-ring[data-v-bb1009e4]{border:3px solid transparent;border-radius:50%;display:inline-block;height:14px;width:14px}.green-ring[data-v-bb1009e4]{background:rgba(78,203,113,.15);border-color:#4ecb71}.blue-ring[data-v-bb1009e4]{background:rgba(91,124,250,.15);border-color:#5b7cfa}.table-wrapper[data-v-bb1009e4]{overflow-x:auto;-webkit-overflow-scrolling:touch}.dt-table[data-v-bb1009e4]{border-collapse:separate;border-spacing:0 6px;width:100%}.dt-table thead tr th[data-v-bb1009e4]{background-color:#e8941a;color:#fff;font-size:13px;font-weight:500;padding:14px 16px;white-space:nowrap}.dt-table thead tr th[data-v-bb1009e4]:first-child{border-radius:10px 0 0 10px}.dt-table thead tr th[data-v-bb1009e4]:last-child{border-radius:0 10px 10px 0}.dt-table tbody tr td[data-v-bb1009e4]{background:var(--bg-card);border-bottom:1px solid var(--border-color);border-top:1px solid var(--border-color);color:var(--text-secondary);font-size:13px;padding:12px 16px}.dt-table tbody tr td[data-v-bb1009e4]:first-child{border-left:1px solid var(--border-color);border-radius:8px 0 0 8px}.dt-table tbody tr td[data-v-bb1009e4]:last-child{border-radius:0 8px 8px 0;border-right:1px solid var(--border-color)}@media only screen and (max-width:992px){.main-content[data-v-bb1009e4]{padding-left:20px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dt_availability.vue?vue&type=template&id=bb1009e4&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-bb1009e4>", "</main>", [_vm._ssrNode("<div class=\"row header-row\" style=\"margin-bottom: 0;\" data-v-bb1009e4><div class=\"col s12\" data-v-bb1009e4><h5 class=\"avail-title\" data-v-bb1009e4>DT Availability Dashboard</h5> <ul class=\"tabs\" data-v-bb1009e4><li class=\"tab\" data-v-bb1009e4><a href=\"#dt-dashboard\" class=\"active tab-link dashboard-tab\" data-v-bb1009e4><i class=\"material-icons tiny tab-icon\" data-v-bb1009e4>speed</i> Dashboard\n                        </a></li> <li class=\"tab\" data-v-bb1009e4><a href=\"#dt-table\" class=\"tab-link table-tab\" data-v-bb1009e4><i class=\"material-icons tiny tab-icon\" data-v-bb1009e4>apps</i> DT Availability Table\n                        </a></li></ul></div></div> "), _vm.loading ? _vm._ssrNode("<div class=\"state-panel\" data-v-bb1009e4>", "</div>", [_c('PreLoader')], 1) : _vm.error ? _vm._ssrNode("<div class=\"state-panel\" data-v-bb1009e4><p class=\"state-message\" data-v-bb1009e4>" + _vm._ssrEscape("Could not load availability data: " + _vm._s(_vm.error)) + "</p> <button class=\"btn-flat retry-btn\" data-v-bb1009e4>Retry</button></div>") : [_vm._ssrNode("<div id=\"dt-dashboard\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"row filter-row\" data-v-bb1009e4><div class=\"col s3 offset-s9\" data-v-bb1009e4><div class=\"filter-pill\" data-v-bb1009e4><span class=\"filter-label\" data-v-bb1009e4>DT Name</span> <i class=\"material-icons filter-arrow\" data-v-bb1009e4>arrow_drop_down</i></div></div></div> "), _vm._ssrNode("<div class=\"row\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card pending-card\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-bb1009e4>DT Target Availability (Hrs)</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  })], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 0 0 6px;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card pending-card\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-bb1009e4>Feeder Target Availability(Hrs)</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  })], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-bb1009e4>DT Actual Availability (Hrs)</p> "), _vm._ssrNode("<p class=\"metric-value green-value\" data-v-bb1009e4>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.dt_actual_availability
    }
  })], 1)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 0 0 6px;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-bb1009e4>Feeder Actual Availability (Hrs)</p> "), _vm._ssrNode("<p class=\"metric-value green-value\" data-v-bb1009e4>", "</p>", [_c('AnimatedValue', {
    staticClass: "value",
    attrs: {
      "value": _vm.feeder_actual_availability
    }
  })], 1)], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 6px 0 0;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-bb1009e4>DT Meeting 20h+ (%)</p> "), _vm._ssrNode("<p class=\"metric-value green-value\" data-v-bb1009e4>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.dt_availability_rate
    }
  })], 1)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s6\" style=\"padding: 0 0 0 6px;\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<div class=\"card-panel metric-card\" data-v-bb1009e4>", "</div>", [_vm._ssrNode("<p class=\"metric-label\" data-v-bb1009e4>Feeder Meeting 20h+ (%)</p> "), _vm._ssrNode("<p class=\"metric-value green-value\" data-v-bb1009e4>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.feeder_availability_rate
    }
  })], 1)], 2)])], 2)], 2), _vm._ssrNode(" <div class=\"col s12 m8\" data-v-bb1009e4><div class=\"card-panel trend-card\" data-v-bb1009e4><div class=\"trend-header\" data-v-bb1009e4><span class=\"trend-title\" data-v-bb1009e4>Availability Trend (last 7 days)</span></div> <div style=\"position: relative; height: 250px;\" data-v-bb1009e4><canvas id=\"availabilityChart\" data-v-bb1009e4></canvas></div> <div class=\"trend-legend\" data-v-bb1009e4><span class=\"legend-item\" data-v-bb1009e4><span class=\"legend-ring green-ring\" data-v-bb1009e4></span> <span class=\"legend-text\" data-v-bb1009e4>Average DT Availability</span></span> <span class=\"legend-item\" data-v-bb1009e4><span class=\"legend-ring blue-ring\" data-v-bb1009e4></span> <span class=\"legend-text\" data-v-bb1009e4>Average Feeder Availability</span></span></div></div></div>")], 2)], 2), _vm._ssrNode(" <div id=\"dt-table\" data-v-bb1009e4><div class=\"row filter-row\" data-v-bb1009e4><div class=\"col s3 offset-s6\" data-v-bb1009e4><div class=\"filter-pill\" data-v-bb1009e4><span class=\"filter-label\" data-v-bb1009e4>All DTs</span> <i class=\"material-icons filter-arrow\" data-v-bb1009e4>arrow_drop_down</i></div></div> <div class=\"col s3\" data-v-bb1009e4><div class=\"filter-pill\" data-v-bb1009e4><span class=\"filter-label\" data-v-bb1009e4>Date</span> <i class=\"material-icons filter-arrow\" style=\"font-size:18px;\" data-v-bb1009e4>calendar_today</i></div></div></div> <p class=\"pending-note\" style=\"margin: 0 0 10px 4px;\" data-v-bb1009e4>" + _vm._ssrEscape("Worst-performing DT meters for " + _vm._s(_vm.resolvedDate)) + "</p> <div class=\"table-wrapper\" data-v-bb1009e4><table class=\"dt-table\" data-v-bb1009e4><thead data-v-bb1009e4><tr data-v-bb1009e4><th data-v-bb1009e4>DT Name</th> <th data-v-bb1009e4>Feeder</th> <th data-v-bb1009e4>Band</th> <th data-v-bb1009e4>Availability (Hrs)</th></tr></thead> <tbody data-v-bb1009e4>" + _vm._ssrList(_vm.dt_availability_data, function (row, i) {
    return "<tr data-v-bb1009e4><td data-v-bb1009e4>" + _vm._ssrEscape(_vm._s(row.dt_name)) + "</td> <td data-v-bb1009e4>" + _vm._ssrEscape(_vm._s(row.feeder_name)) + "</td> <td data-v-bb1009e4>" + _vm._ssrEscape(_vm._s(row.band)) + "</td> <td data-v-bb1009e4>" + _vm._ssrEscape(_vm._s(row.availability_hours)) + "</td></tr>";
  }) + " " + (!_vm.dt_availability_data.length ? "<tr data-v-bb1009e4><td colspan=\"4\" class=\"center-align pending-note\" data-v-bb1009e4>No worst-performer rows returned</td></tr>" : "<!---->") + "</tbody></table></div></div>")]], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/dt_availability.vue?vue&type=template&id=bb1009e4&scoped=true
  ...
  methods: {
    async getData() {
      ...
      try {
        ...
        const dtAvgHours = Object(controlCenterApi["o" /* pick */])(dtAvail, ['summary.avg_dt_availability_hours'], null);
        const feederAvgHours = Object(controlCenterApi["o" /* pick */])(feederAvail, ['summary.avg_feeder_availability_hours'], null);
        ...
        const dtMetPct = Object(controlCenterApi["o" /* pick */])(dtAvail, ['summary.met_20_hours_pct'], null);
        const feederMetPct = Object(controlCenterApi["o" /* pick */])(feederAvail, ['summary.met_20_hours_pct'], null);
        this.dt_availability_rate = dtMetPct != null ? `${dtMetPct}` : '0';
        this.feeder_availability_rate = feederMetPct != null ? `${feederMetPct}` : '0';
        this.resolvedDate = Object(controlCenterApi["o" /* pick */])(dtAvail, ['selected_date'], '—');
        ...
        this.dt_availability_data = worstMeters.map(row => ({
          ...
          band: Object(controlCenterApi["o" /* pick */])(row, ['band_code', 'band', 'myto_band'], '—'),
          availability_hours: Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["o" /* pick */])(row, ['dt_availability_hours', 'dt_availability', 'availability_hours', 'hours'], 0))
        }));
        await this.loadTrend(Object(controlCenterApi["o" /* pick */])(dtAvail, ['selected_date'], null));
      } catch (err) {
