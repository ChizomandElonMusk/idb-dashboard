...
/* harmony default export */ var dt_availabilityvue_type_script_lang_js = ({
  ...
  methods: {
    async getData() {
      ...
      try {
        const [dtAvail, feederAvail] = await Promise.all([controlCenterApi["e" /* getDtAvailability */]({
          limit: 10
        }), controlCenterApi["g" /* getFeederAvailability */]({
          limit: 10
        })]);
        const dtAvgHours = Object(controlCenterApi["r" /* pick */])(dtAvail, ['summary.avg_dt_availability_hours'], null);
        const feederAvgHours = Object(controlCenterApi["r" /* pick */])(feederAvail, ['summary.avg_feeder_availability_hours'], null);
        ...
        const dtMetPct = Object(controlCenterApi["r" /* pick */])(dtAvail, ['summary.met_20_hours_pct'], null);
        const feederMetPct = Object(controlCenterApi["r" /* pick */])(feederAvail, ['summary.met_20_hours_pct'], null);
        this.dt_availability_rate = dtMetPct != null ? `${dtMetPct}` : '0';
        this.feeder_availability_rate = feederMetPct != null ? `${feederMetPct}` : '0';
        this.resolvedDate = Object(controlCenterApi["r" /* pick */])(dtAvail, ['selected_date'], '—');
        const worstMeters = Object(controlCenterApi["r" /* pick */])(dtAvail, ['worst_dt_meters'], []) || [];
        this.dt_availability_data = worstMeters.map(row => ({
          dt_name: Object(controlCenterApi["r" /* pick */])(row, ['dt_name', 'name', 'r_meter_id'], '—'),
          feeder_name: Object(controlCenterApi["r" /* pick */])(row, ['feeder_name', 'feeder'], '—'),
          band: Object(controlCenterApi["r" /* pick */])(row, ['band_code', 'band', 'myto_band'], '—'),
          availability_hours: Object(controlCenterApi["b" /* formatNumber */])(Object(controlCenterApi["r" /* pick */])(row, ['dt_availability_hours', 'dt_availability', 'availability_hours', 'hours'], 0))
        }));
        await this.loadTrend(Object(controlCenterApi["r" /* pick */])(dtAvail, ['selected_date'], null));
      } catch (err) {
    ...
    async loadTrend(baseDate) {
      const days = Object(controlCenterApi["o" /* lastNDays */])(baseDate, 7);
      const [dtResponses, feederResponses] = await Promise.all([Promise.all(days.map(d => controlCenterApi["e" /* getDtAvailability */]({
        date: d
      }).catch(() => null))), Promise.all(days.map(d => controlCenterApi["g" /* getFeederAvailability */]({
        date: d
      }).catch(() => null)))]);
      this.renderTrendChart(days.map(controlCenterApi["a" /* dayLabel */]), dtResponses.map(r => Object(controlCenterApi["r" /* pick */])(r, ['summary.avg_dt_availability_hours'], null)), feederResponses.map(r => Object(controlCenterApi["r" /* pick */])(r, ['summary.avg_feeder_availability_hours'], null)));
    },
...
installComponents(component, {SideNav: __webpack_require__(41).default,PreLoader: __webpack_require__(49).default,CertificationBadge: __webpack_require__(52).default,AnimatedValue: __webpack_require__(46).default})
