...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("63d2a536", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_32615469_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(65);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_32615469_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_32615469_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_32615469_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_32615469_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-32615469]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-32615469]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-header[data-v-32615469]{align-items:center;display:flex;justify-content:space-between;margin-bottom:20px}.avail-title[data-v-32615469]{color:var(--text-primary);font-weight:600;margin:0}.state-panel[data-v-32615469]{align-items:center;display:flex;flex-direction:column;gap:12px;justify-content:center;padding:60px 20px}.state-message[data-v-32615469]{color:var(--text-secondary);text-align:center}.retry-btn[data-v-32615469]{border:1px solid var(--border-strong);border-radius:6px;color:var(--text-primary)}.pending-card[data-v-32615469]{text-align:center}.band-avail-table[data-v-32615469]{font-size:13px;width:100%}.band-status[data-v-32615469]{font-weight:600}.status-red[data-v-32615469]{color:#e74c3c}.status-green[data-v-32615469]{color:#27ae60}.status-orange[data-v-32615469]{color:#f39c12}.pending-note[data-v-32615469]{color:var(--text-muted);font-size:12px;margin:8px 0 0}.filter-row[data-v-32615469]{margin-bottom:10px}.filter-pill[data-v-32615469]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;justify-content:space-between;padding:8px 12px}.filter-label[data-v-32615469]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-32615469]{color:var(--text-muted);font-size:20px!important}.total-card[data-v-32615469]{border-radius:12px;margin-bottom:8px;padding:18px;position:relative}.total-card-inner[data-v-32615469]{gap:14px}.total-card-inner[data-v-32615469],.total-icon[data-v-32615469]{align-items:center;display:flex}.total-icon[data-v-32615469]{background-color:#f39c12;border-radius:50%;flex-shrink:0;height:52px;justify-content:center;width:52px}.total-value[data-v-32615469]{color:var(--text-primary);font-size:26px;font-weight:700;margin:0 0 2px}.total-label[data-v-32615469]{color:var(--text-secondary);font-size:12px;margin:0 0 2px}.total-date[data-v-32615469]{color:var(--text-muted);font-size:12px;margin:0}.band-row[data-v-32615469]{margin-bottom:0}.band-card[data-v-32615469]{border-radius:12px;margin-bottom:10px;padding:14px}.band-name[data-v-32615469]{color:var(--text-secondary);font-size:13px;font-weight:500;margin:0 0 4px}.band-pct[data-v-32615469]{color:var(--text-primary);font-size:22px;font-weight:700;margin:0 0 2px}.band-target[data-v-32615469]{color:var(--text-faint);font-size:11px;margin:4px 0 0}.trend-card[data-v-32615469]{border-radius:12px;margin-bottom:10px;padding:20px}.trend-header[data-v-32615469]{align-items:center;display:flex;justify-content:space-between;margin-bottom:16px}.trend-title[data-v-32615469]{color:var(--text-primary);font-size:15px;font-weight:600}.mini-card[data-v-32615469]{border-radius:12px;padding:16px}.mini-title[data-v-32615469]{color:var(--text-primary);font-size:14px;font-weight:600;margin:0 0 12px}.feeder-legend[data-v-32615469]{display:grid;grid-template-columns:1fr 1fr;grid-gap:8px 4px;gap:8px 4px;margin-top:12px}.feeder-legend-item[data-v-32615469]{align-items:center;display:flex;gap:6px}.fleg-dot[data-v-32615469]{border-radius:50%;flex-shrink:0;height:12px;width:12px}.fleg-name[data-v-32615469]{color:var(--text-secondary);flex:1;font-size:12px}.fleg-val[data-v-32615469]{color:var(--text-primary);font-size:12px;font-weight:700}@media only screen and (max-width:992px){.main-content[data-v-32615469]{padding-left:20px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/myto_dashboard.vue?vue&type=template&id=32615469&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-32615469>", "</main>", [_vm._ssrNode("<div class=\"avail-header\" data-v-32615469><h5 class=\"avail-title\" data-v-32615469>Feeders MYTO Energy Dashboard</h5></div> <div class=\"row filter-row\" data-v-32615469><div class=\"col s3 offset-s9\" data-v-32615469><div class=\"filter-pill\" data-v-32615469><span class=\"filter-label\" data-v-32615469>Feeder Band</span> <i class=\"material-icons filter-arrow\" data-v-32615469>arrow_drop_down</i></div></div></div> "), _vm.loading ? _vm._ssrNode("<div class=\"state-panel\" data-v-32615469>", "</div>", [_c('PreLoader')], 1) : _vm.error ? _vm._ssrNode("<div class=\"state-panel\" data-v-32615469><p class=\"state-message\" data-v-32615469>" + _vm._ssrEscape("Could not load MYTO dashboard data: " + _vm._s(_vm.error)) + "</p> <button class=\"btn-flat retry-btn\" data-v-32615469>Retry</button></div>") : _vm._ssrNode("<div class=\"row\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"card-panel total-card\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"total-card-inner\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"total-icon\" data-v-32615469><i class=\"material-icons white-text\" data-v-32615469>bolt</i></div> "), _vm._ssrNode("<div class=\"total-info\" data-v-32615469>", "</div>", [_vm._ssrNode("<p class=\"total-value\" data-v-32615469>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.total_consumption
    }
  })], 1), _vm._ssrNode(" <p class=\"total-label\" data-v-32615469>Total DT Energy Raw</p> <p class=\"total-date\" data-v-32615469>" + _vm._ssrEscape(_vm._s(_vm.consumption_date)) + "</p>")], 2)], 2)]), _vm._ssrNode(" "), _vm._l(_vm.bandChunks, function (chunk, ci) {
    return _vm._ssrNode("<div class=\"row band-row\" data-v-32615469>", "</div>", _vm._l(chunk, function (band, bi) {
      return _vm._ssrNode("<div class=\"col s6\"" + _vm._ssrStyle(null, bi === 0 ? 'padding-right:5px;' : 'padding-left:5px;', null) + " data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"card-panel band-card\" data-v-32615469>", "</div>", [_vm._ssrNode("<p class=\"band-name\" data-v-32615469>" + _vm._ssrEscape(_vm._s(band.name)) + "</p> "), _vm._ssrNode("<p class=\"band-pct\" data-v-32615469>", "</p>", [_c('AnimatedValue', {
        attrs: {
          "value": band.pct
        }
      })], 1), _vm._ssrNode(" <p class=\"band-target\" data-v-32615469>share of total DT energy</p> <p class=\"band-target\" data-v-32615469>" + _vm._ssrEscape("DTs in band: " + _vm._s(band.count)) + "</p>")], 2)]);
    }), 0);
  }), _vm._ssrNode(" " + (!_vm.bands.length ? "<p class=\"pending-note\" data-v-32615469>No band energy data returned</p>" : "<!---->"))], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m8\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"card-panel trend-card\" data-v-32615469><div class=\"trend-header\" data-v-32615469><span class=\"trend-title\" data-v-32615469>DT Energy Raw Trend (last 6 months)</span></div> <div style=\"position: relative; height: 200px;\" data-v-32615469><canvas id=\"energyTrendChart\" data-v-32615469></canvas></div></div> "), _vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"col s12 m6\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-card\" data-v-32615469>", "</div>", [_vm._ssrNode("<p class=\"mini-title\" data-v-32615469>DT Energy Raw by Band</p> "), _vm.energyPerFeederData ? _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
      "chart-data": _vm.energyPerFeederData,
      "chart-options": _vm.doughnutOptions
    }
  }) : _vm._e(), _vm._ssrNode(" <div class=\"feeder-legend\" data-v-32615469>" + _vm._ssrList(_vm.energyLegend, function (item) {
    return "<div class=\"feeder-legend-item\" data-v-32615469><span class=\"fleg-dot\"" + _vm._ssrStyle(null, {
      backgroundColor: item.color
    }, null) + " data-v-32615469></span> <span class=\"fleg-name\" data-v-32615469>" + _vm._ssrEscape(_vm._s(item.name)) + "</span> <span class=\"fleg-val\" data-v-32615469>" + _vm._ssrEscape(_vm._s(item.value)) + "</span></div>";
  }) + "</div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m6\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-card pending-card\" data-v-32615469>", "</div>", [_vm._ssrNode("<p class=\"mini-title\" data-v-32615469>Feeder Communication Status</p> "), _c('CertificationBadge', {
    attrs: {
      "status": "pending"
    }
  }), _vm._ssrNode(" <p class=\"pending-note\" data-v-32615469>Meter communication data pending source onboarding</p>")], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-32615469>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-card\" data-v-32615469>", "</div>", [_vm._ssrNode("<p class=\"mini-title\" data-v-32615469>", "</p>", [_vm._ssrNode("Availability by Band "), _c('CertificationBadge', {
    attrs: {
      "status": "ready"
    }
  })], 2), _vm._ssrNode(" <div class=\"table-wrapper\" data-v-32615469><table class=\"band-avail-table striped\" data-v-32615469><thead data-v-32615469><tr data-v-32615469><th data-v-32615469>Band</th> <th data-v-32615469>Avg DT Availability (Hrs)</th></tr></thead> <tbody data-v-32615469>" + _vm._ssrList(_vm.bandAvailability, function (band) {
    return "<tr data-v-32615469><td data-v-32615469>" + _vm._ssrEscape(_vm._s(band.name)) + "</td> <td data-v-32615469>" + _vm._ssrEscape(_vm._s(band.avail_hours)) + "</td></tr>";
  }) + " " + (!_vm.bandAvailability.length ? "<tr data-v-32615469><td colspan=\"2\" class=\"center-align pending-note\" data-v-32615469>No band availability data returned</td></tr>" : "<!---->") + "</tbody></table></div>")], 2)])])], 2)], 2)], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/myto_dashboard.vue?vue&type=template&id=32615469&scoped=true
...
// Live API wiring — see static/control_center_api_doc.md §11 (MYTO Dashboard). band_summary now
// carries DT availability per band too (certification_status.dt_availability_by_band is certified).
...
/* harmony default export */ var myto_dashboardvue_type_script_lang_js = ({
  ...
  methods: {
    async getData() {
      ...
      this.error = null;
      try {
        const myto = await controlCenterApi["j" /* getMytoDashboard */]();
        const totalDtEnergy = Object(controlCenterApi["o" /* pick */])(myto, ['summary.total_dt_energy_raw'], null);
        this.total_consumption = totalDtEnergy != null ? Object(controlCenterApi["b" /* formatNumber */])(totalDtEnergy) : '0';
        const monthStart = Object(controlCenterApi["o" /* pick */])(myto, ['month', 'summary.month_start'], null);
        ...
        // avg_dt_availability_hours, ...), not an object keyed by band name
        const bandSummary = Object(controlCenterApi["o" /* pick */])(myto, ['band_summary'], []) || [];
        this.bands = this.buildBands(bandSummary, totalDtEnergy);
        this.bandAvailability = this.buildBandAvailability(bandSummary);
        if (this.bands.length) {
          this.energyLegend = this.bands.map((b, i) => ({
            name: b.name,
            color: BAND_COLORS[i % BAND_COLORS.length],
            value: Object(controlCenterApi["b" /* formatNumber */])(b.energy)
          }));
    ...
    buildBands(bandSummary, totalEnergy) {
      const denom = totalEnergy || bandSummary.reduce((sum, b) => sum + (Number(Object(controlCenterApi["o" /* pick */])(b, ['dt_energy_raw'], 0)) || 0), 0) || 1;
      return bandSummary.map(b => {
        const energy = Number(Object(controlCenterApi["o" /* pick */])(b, ['dt_energy_raw'], 0)) || 0;
        const totalDts = Object(controlCenterApi["o" /* pick */])(b, ['total_dts'], null);
        const count = totalDts != null ? Object(controlCenterApi["b" /* formatNumber */])(totalDts) : '—';
        const pct = denom ? energy / denom * 100 : 0;
        return {
          name: `Band ${Object(controlCenterApi["o" /* pick */])(b, ['band_code'], '—')}`,
          pct: `${pct.toFixed(2)}%`,
          count,
          energy
        };
    ...
    buildBandAvailability(bandSummary) {
      return bandSummary.map(b => {
        const hours = Object(controlCenterApi["o" /* pick */])(b, ['avg_dt_availability_hours', 'dt_availability_hours', 'avg_availability_hours'], null);
        return hours != null ? {
          name: `Band ${Object(controlCenterApi["o" /* pick */])(b, ['band_code'], '—')}`,
          avail_hours: Number(hours).toFixed(2)
        } : null;
      }).filter(Boolean);
    },
    async loadTrend(baseMonth) {
      const months = Object(controlCenterApi["m" /* lastNMonths */])(baseMonth, 6);
      const responses = await Promise.all(months.map(m => controlCenterApi["j" /* getMytoDashboard */]({
        month: m
      }).catch(() => null)));
      this.renderTrendChart(months.map(controlCenterApi["n" /* monthLabel */]), responses.map(r => Object(controlCenterApi["o" /* pick */])(r, ['summary.total_dt_energy_raw'], null)));
    },
          ...
          tooltips: {
            ...
            callbacks: {
              label: function (tooltipItems) {
                return Number(tooltipItems.yLabel).toLocaleString() + ' (raw)';
              }
            }
          },
          scales: {
...
/* nuxt-component-imports */
installComponents(component, {SideNav: __webpack_require__(42).default,PreLoader: __webpack_require__(52).default,AnimatedValue: __webpack_require__(55).default,ChartPie: __webpack_require__(53).default,CertificationBadge: __webpack_require__(54).default})
