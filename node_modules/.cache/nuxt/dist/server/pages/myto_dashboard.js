...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("2188716a", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_16120662_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_16120662_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_16120662_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_16120662_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_myto_dashboard_vue_vue_type_style_index_0_id_16120662_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".dashboard-wrapper[data-v-16120662]{background-color:var(--bg-page);min-height:100vh}.main-content[data-v-16120662]{padding-left:280px;padding-right:20px;padding-top:20px}.avail-header[data-v-16120662]{align-items:center;display:flex;justify-content:space-between;margin-bottom:20px}.avail-title[data-v-16120662]{color:var(--text-primary);font-weight:600;margin:0}.filter-row[data-v-16120662]{margin-bottom:10px}.filter-pill[data-v-16120662]{align-items:center;background:var(--bg-card);border:1px solid var(--border-strong);border-radius:8px;cursor:pointer;display:flex;justify-content:space-between;padding:8px 12px}.filter-label[data-v-16120662]{color:var(--text-secondary);font-size:13px}.filter-arrow[data-v-16120662]{color:var(--text-muted);font-size:20px!important}.total-card[data-v-16120662]{border-radius:12px;margin-bottom:8px;padding:18px;position:relative}.total-card-inner[data-v-16120662]{gap:14px}.total-card-inner[data-v-16120662],.total-icon[data-v-16120662]{align-items:center;display:flex}.total-icon[data-v-16120662]{background-color:#f39c12;border-radius:50%;flex-shrink:0;height:52px;justify-content:center;width:52px}.total-value[data-v-16120662]{color:var(--text-primary);font-size:26px;font-weight:700;margin:0 0 2px}.total-label[data-v-16120662]{color:var(--text-secondary);font-size:12px;margin:0 0 2px}.total-date[data-v-16120662]{color:var(--text-muted);font-size:12px;margin:0}.total-badge[data-v-16120662]{background:#27ae60;border-radius:6px;bottom:18px;color:#fff;font-size:11px;font-weight:600;padding:3px 8px;position:absolute;right:18px}.band-row[data-v-16120662]{margin-bottom:0}.band-card[data-v-16120662]{border-radius:12px;margin-bottom:10px;padding:14px}.band-name[data-v-16120662]{color:var(--text-secondary);font-size:13px;font-weight:500;margin:0 0 4px}.band-pct[data-v-16120662]{color:var(--text-primary);font-size:22px;font-weight:700;margin:0 0 2px}.band-target[data-v-16120662]{color:var(--text-faint);font-size:11px;margin:4px 0 0}.band-status[data-v-16120662]{font-size:16px;font-weight:600;margin:0}.status-red[data-v-16120662]{color:#e74c3c}.status-green[data-v-16120662]{color:#27ae60}.status-orange[data-v-16120662]{color:#f39c12}.trend-card[data-v-16120662]{border-radius:12px;margin-bottom:10px;padding:20px}.trend-header[data-v-16120662]{align-items:center;display:flex;justify-content:space-between;margin-bottom:16px}.trend-title[data-v-16120662]{color:var(--text-primary);font-size:15px;font-weight:600}.period-btns[data-v-16120662]{align-items:center;display:flex;gap:4px}.period-btn[data-v-16120662]{border-radius:6px;color:var(--text-faint);font-size:13px;height:32px;line-height:32px;padding:0 10px;text-transform:none}.active-period[data-v-16120662]{background:var(--bg-card-alt);box-shadow:0 1px 3px var(--shadow-color);color:var(--text-primary);font-weight:600}.active-period[data-v-16120662],.icon-btn[data-v-16120662]{border:1px solid var(--border-strong)}.icon-btn[data-v-16120662]{align-items:center;border-radius:6px;display:flex;padding:0 8px}.mini-card[data-v-16120662]{border-radius:12px;padding:16px}.mini-title[data-v-16120662]{color:var(--text-primary);font-size:14px;font-weight:600;margin:0 0 12px}.feeder-legend[data-v-16120662]{display:grid;grid-template-columns:1fr 1fr;grid-gap:8px 4px;gap:8px 4px;margin-top:12px}.feeder-legend-item[data-v-16120662]{align-items:center;display:flex;gap:6px}.fleg-dot[data-v-16120662]{border-radius:50%;flex-shrink:0;height:12px;width:12px}.fleg-name[data-v-16120662]{color:var(--text-secondary);flex:1;font-size:12px}.fleg-val[data-v-16120662]{color:var(--text-primary);font-size:12px;font-weight:700}@media only screen and (max-width:992px){.main-content[data-v-16120662]{padding-left:20px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/myto_dashboard.vue?vue&type=template&id=16120662&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "dashboard-wrapper"
  }, [_c('SideNav'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"main-content\" data-v-16120662>", "</main>", [_vm._ssrNode("<div class=\"avail-header\" data-v-16120662><h5 class=\"avail-title\" data-v-16120662>Feeders MYTO Energy Dashboard</h5></div> <div class=\"row filter-row\" data-v-16120662><div class=\"col s3 offset-s9\" data-v-16120662><div class=\"filter-pill\" data-v-16120662><span class=\"filter-label\" data-v-16120662>Feeder Band</span> <i class=\"material-icons filter-arrow\" data-v-16120662>arrow_drop_down</i></div></div></div> "), _vm._ssrNode("<div class=\"row\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"col s12 m4\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"card-panel total-card\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"total-card-inner\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"total-icon\" data-v-16120662><i class=\"material-icons white-text\" data-v-16120662>bolt</i></div> "), _vm._ssrNode("<div class=\"total-info\" data-v-16120662>", "</div>", [_vm._ssrNode("<p class=\"total-value\" data-v-16120662>", "</p>", [_c('AnimatedValue', {
    attrs: {
      "value": _vm.total_consumption
    }
  })], 1), _vm._ssrNode(" <p class=\"total-label\" data-v-16120662>Total Consumption (MWh)</p> <p class=\"total-date\" data-v-16120662>" + _vm._ssrEscape(_vm._s(_vm.consumption_date)) + "</p>")], 2)], 2), _vm._ssrNode(" <span class=\"total-badge\" data-v-16120662>+13.6% ↑</span>")], 2), _vm._ssrNode(" "), _vm._l(_vm.bandChunks, function (chunk, ci) {
    return _vm._ssrNode("<div class=\"row band-row\" data-v-16120662>", "</div>", _vm._l(chunk, function (band, bi) {
      return _vm._ssrNode("<div class=\"col s6\"" + _vm._ssrStyle(null, bi === 0 ? 'padding-right:5px;' : 'padding-left:5px;', null) + " data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"card-panel band-card\" data-v-16120662>", "</div>", [_vm._ssrNode("<p class=\"band-name\" data-v-16120662>" + _vm._ssrEscape(_vm._s(band.name)) + "</p> "), _vm._ssrNode("<p class=\"band-pct\" data-v-16120662>", "</p>", [_c('AnimatedValue', {
        attrs: {
          "value": band.pct
        }
      })], 1), _vm._ssrNode(" <p" + _vm._ssrClass("band-status", band.statusClass) + " data-v-16120662>" + _vm._ssrEscape(_vm._s(band.status)) + "</p> <p class=\"band-target\" data-v-16120662>" + _vm._ssrEscape("NERC Target " + _vm._s(band.target)) + "</p>")], 2)]);
    }), 0);
  })], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m8\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"card-panel trend-card\" data-v-16120662><div class=\"trend-header\" data-v-16120662><span class=\"trend-title\" data-v-16120662>Energy Consumption Trend</span> <div class=\"period-btns\" data-v-16120662><button class=\"btn-flat period-btn active-period\" data-v-16120662>Day</button> <button class=\"btn-flat period-btn\" data-v-16120662>Week</button> <button class=\"btn-flat period-btn\" data-v-16120662>Month</button> <button class=\"btn-flat period-btn icon-btn\" data-v-16120662><i class=\"material-icons\" style=\"font-size:18px;\" data-v-16120662>calendar_today</i></button></div></div> <div style=\"position: relative; height: 200px;\" data-v-16120662><canvas id=\"energyTrendChart\" data-v-16120662></canvas></div></div> "), _vm._ssrNode("<div class=\"row\" style=\"margin-bottom: 0;\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"col s12 m6\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-card\" data-v-16120662>", "</div>", [_vm._ssrNode("<p class=\"mini-title\" data-v-16120662>Energy Per Feeder (MWh)</p> "), _vm.energyPerFeederData ? _c('ChartPie', {
    attrs: {
      "chart-type": "doughnut",
      "chart-data": _vm.energyPerFeederData,
      "chart-options": _vm.doughnutOptions
    }
  }) : _vm._e(), _vm._ssrNode(" <div class=\"feeder-legend\" data-v-16120662>" + _vm._ssrList(_vm.energyLegend, function (item) {
    return "<div class=\"feeder-legend-item\" data-v-16120662><span class=\"fleg-dot\"" + _vm._ssrStyle(null, {
      backgroundColor: item.color
    }, null) + " data-v-16120662></span> <span class=\"fleg-name\" data-v-16120662>" + _vm._ssrEscape(_vm._s(item.name)) + "</span> <span class=\"fleg-val\" data-v-16120662>" + _vm._ssrEscape(_vm._s(item.value)) + "</span></div>";
  }) + "</div>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col s12 m6\" data-v-16120662>", "</div>", [_vm._ssrNode("<div class=\"card-panel mini-card\" data-v-16120662>", "</div>", [_vm._ssrNode("<p class=\"mini-title\" data-v-16120662>Feeder Communication Status</p> "), _c('MeterCommunication', {
    attrs: {
...
// CONCATENATED MODULE: ./pages/myto_dashboard.vue?vue&type=template&id=16120662&scoped=true
...
/* harmony default export */ var myto_dashboardvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    initTrendChart() {
      ...
      if (!ctx) return;
      new Chart_default.a(ctx.getContext('2d'), {
        type: 'line',
        data: {
